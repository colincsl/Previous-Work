...
static SFc8_PongInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_Pong(void);
static void initialize_params_c8_Pong(void);
static void enable_c8_Pong(void);
static void disable_c8_Pong(void);
static void ext_mode_exec_c8_Pong(void);
static void finalize_c8_Pong(void);
static void sf_c8_Pong(void);
...
static void initialize_c8_Pong(void)
{
  uint8_T *c8_is_active_c8_Pong;
  c8_is_active_c8_Pong = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_Pong = 0U;
}
...
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[23])
{
  ...
  c8_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[0].fileLength = 791U;
  c8_info[0].fileTime1 = 1160446618U;
  c8_info[0].fileTime2 = 0U;
  c8_info[1].context = "";
  c8_info[1].name = "pi";
  c8_info[1].dominantType = "";
  c8_info[1].resolved = "[B]pi";
  c8_info[1].fileLength = 0U;
  c8_info[1].fileTime1 = 0U;
  c8_info[1].fileTime2 = 0U;
  c8_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[2].name = "isreal";
  c8_info[2].dominantType = "double";
  c8_info[2].resolved = "[B]isreal";
  ...
  c8_info[4].name = "isnumeric";
  c8_info[4].dominantType = "double";
  c8_info[4].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c8_info[4].fileLength = 250U;
  c8_info[4].fileTime1 = 1160446622U;
  c8_info[4].fileTime2 = 0U;
  c8_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[5].name = "size";
  c8_info[5].dominantType = "double";
  c8_info[5].resolved = "[B]size";
  c8_info[5].fileLength = 0U;
  c8_info[5].fileTime1 = 0U;
  c8_info[5].fileTime2 = 0U;
  c8_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[6].name = "eml_is_float_class";
  c8_info[6].dominantType = "char";
  c8_info[6].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c8_info[6].fileLength = 273U;
  c8_info[6].fileTime1 = 1160446744U;
  ...
  c8_info[10].fileLength = 243U;
  c8_info[10].fileTime1 = 1160446704U;
  c8_info[10].fileTime2 = 0U;
  c8_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[11].name = "ge";
  c8_info[11].dominantType = "double";
  c8_info[11].resolved = "[B]ge";
  ...
  c8_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[13].name = "eml_numel";
  c8_info[13].dominantType = "double";
  c8_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c8_info[13].fileLength = 278U;
  c8_info[13].fileTime1 = 1163970802U;
  ...
  c8_info[15].context = "";
  c8_info[15].name = "mrdivide";
  c8_info[15].dominantType = "double";
  c8_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[15].fileLength = 653U;
  c8_info[15].fileTime1 = 1160446802U;
  c8_info[15].fileTime2 = 0U;
  c8_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[16].name = "eml_assert";
  c8_info[16].dominantType = "char";
  c8_info[16].resolved = "[B]eml_assert";
  ...
  c8_info[18].context = "";
  c8_info[18].name = "minus";
  c8_info[18].dominantType = "double";
  c8_info[18].resolved = "[B]minus";
  ...
  c8_info[19].fileLength = 244U;
  c8_info[19].fileTime1 = 1160446834U;
  c8_info[19].fileTime2 = 0U;
  c8_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c8_info[21].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c8_info[21].name = "length";
  c8_info[21].dominantType = "double";
  c8_info[21].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[21].fileLength = 347U;
  c8_info[21].fileTime1 = 1163970770U;
  c8_info[21].fileTime2 = 0U;
  c8_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[22].name = "strcmp";
  c8_info[22].dominantType = "char";
  c8_info[22].resolved = "[B]strcmp";
...
/* SFunction Glue Code */
void sf_c8_Pong_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Pong_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c8_Pong(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_Pong();
  initialize_c8_Pong();
}

static void sf_opaque_enable_c8_Pong(void *chartInstanceVar)
{
  enable_c8_Pong();
}

static void sf_opaque_disable_c8_Pong(void *chartInstanceVar)
{
  disable_c8_Pong();
}

static void sf_opaque_gateway_c8_Pong(void *chartInstanceVar)
{
  sf_c8_Pong();
}

static void sf_opaque_ext_mode_exec_c8_Pong(void *chartInstanceVar)
{
  ext_mode_exec_c8_Pong();
}

static void sf_opaque_terminate_c8_Pong(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c8_Pong(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Pong",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Pong",8,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Pong",8,1);
      sf_mark_chart_reusable_outputs(S,"Pong",8,1);
    }
    sf_set_rtw_dwork_info(S,"Pong",8);
...
static void mdlRTW_c8_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Pong", 8);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c8_Pong(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c8_Pong;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c8_Pong;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c8_Pong;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c8_Pong;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c8_Pong;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_Pong;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_Pong;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_Pong;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c8_Pong;
...
void c8_Pong_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Pong(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Pong(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c8_Pong_method_dispatcher.\n"
