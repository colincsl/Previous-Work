...
static SFc5_PongInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c5_Pong(void);
static void initialize_params_c5_Pong(void);
static void enable_c5_Pong(void);
static void disable_c5_Pong(void);
static void ext_mode_exec_c5_Pong(void);
static void finalize_c5_Pong(void);
static void sf_c5_Pong(void);
...
static void initialize_c5_Pong(void)
{
  uint8_T *c5_is_active_c5_Pong;
  c5_is_active_c5_Pong = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_Pong = 0U;
}
...
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[49])
{
  ...
  c5_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[0].fileLength = 772U;
  c5_info[0].fileTime1 = 1163970724U;
  ...
  c5_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[2].name = "isfloat";
  c5_info[2].dominantType = "double";
  c5_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c5_info[2].fileLength = 182U;
  c5_info[2].fileTime1 = 1160446620U;
  c5_info[2].fileTime2 = 0U;
  c5_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[3].name = "true";
  c5_info[3].dominantType = "";
  c5_info[3].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[3].fileLength = 625U;
  c5_info[3].fileTime1 = 1163970786U;
  c5_info[3].fileTime2 = 0U;
  c5_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  ...
  c5_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[5].name = "all";
  c5_info[5].dominantType = "logical";
  c5_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[5].fileLength = 2066U;
  c5_info[5].fileTime1 = 1166598650U;
  c5_info[5].fileTime2 = 0U;
  c5_info[6].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[6].name = "nargout";
  c5_info[6].dominantType = "";
  c5_info[6].resolved = "[B]nargout";
  c5_info[6].fileLength = 0U;
  c5_info[6].fileTime1 = 0U;
  c5_info[6].fileTime2 = 0U;
  c5_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[7].name = "length";
  c5_info[7].dominantType = "double";
  c5_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[7].fileLength = 347U;
  c5_info[7].fileTime1 = 1163970770U;
  c5_info[7].fileTime2 = 0U;
  c5_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[8].name = "not";
  c5_info[8].dominantType = "logical";
  c5_info[8].resolved = "[B]not";
  ...
  c5_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[13].name = "logical";
  c5_info[13].dominantType = "double";
  c5_info[13].resolved = "[B]logical";
  ...
  c5_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[15].fileLength = 653U;
  c5_info[15].fileTime1 = 1160446802U;
  c5_info[15].fileTime2 = 0U;
  c5_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[16].name = "eml_is_integer_class";
  c5_info[16].dominantType = "char";
  c5_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c5_info[16].fileLength = 462U;
  c5_info[16].fileTime1 = 1160446744U;
  c5_info[16].fileTime2 = 0U;
  c5_info[17].context = "";
  c5_info[17].name = "pi";
  c5_info[17].dominantType = "";
  c5_info[17].resolved = "[B]pi";
  ...
  c5_info[19].fileLength = 953U;
  c5_info[19].fileTime1 = 1160446742U;
  ...
  c5_info[21].context = "";
  c5_info[21].name = "uminus";
  c5_info[21].dominantType = "double";
  c5_info[21].resolved = "[B]uminus";
  c5_info[21].fileLength = 0U;
  c5_info[21].fileTime1 = 0U;
  c5_info[21].fileTime2 = 0U;
  c5_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[22].name = "rdivide";
  c5_info[22].dominantType = "double";
  c5_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[22].fileLength = 4533U;
  c5_info[22].fileTime1 = 1177099748U;
  c5_info[22].fileTime2 = 0U;
  c5_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[23].name = "eml_is_float_class";
  c5_info[23].dominantType = "char";
  c5_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c5_info[23].fileLength = 273U;
  c5_info[23].fileTime1 = 1160446744U;
  ...
  c5_info[26].context = "";
  c5_info[26].name = "mtimes";
  c5_info[26].dominantType = "double";
  c5_info[26].resolved = "[B]mtimes";
  c5_info[26].fileLength = 0U;
  c5_info[26].fileTime1 = 0U;
  c5_info[26].fileTime2 = 0U;
  c5_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[27].name = "ndims";
  c5_info[27].dominantType = "double";
  c5_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c5_info[27].fileLength = 236U;
  c5_info[27].fileTime1 = 1163970776U;
  c5_info[27].fileTime2 = 0U;
  c5_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[28].name = "int32";
  c5_info[28].dominantType = "double";
  c5_info[28].resolved = "[B]int32";
  c5_info[28].fileLength = 0U;
  c5_info[28].fileTime1 = 0U;
  c5_info[28].fileTime2 = 0U;
  c5_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  ...
  c5_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[30].name = "islogical";
  c5_info[30].dominantType = "logical";
  c5_info[30].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/islogical.m";
  c5_info[30].fileLength = 186U;
  c5_info[30].fileTime1 = 1160446622U;
  c5_info[30].fileTime2 = 0U;
  c5_info[31].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[31].name = "isvector";
  c5_info[31].dominantType = "double";
  c5_info[31].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c5_info[31].fileLength = 284U;
  c5_info[31].fileTime1 = 1160446706U;
  c5_info[31].fileTime2 = 0U;
  c5_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[32].name = "numel";
  c5_info[32].dominantType = "double";
  c5_info[32].resolved = "[B]numel";
  c5_info[32].fileLength = 0U;
  c5_info[32].fileTime1 = 0U;
  c5_info[32].fileTime2 = 0U;
  c5_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[33].name = "isscalar";
  c5_info[33].dominantType = "double";
  c5_info[33].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[33].fileLength = 243U;
  c5_info[33].fileTime1 = 1160446704U;
  c5_info[33].fileTime2 = 0U;
  c5_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[34].name = "eml_nonsingleton_dim";
  c5_info[34].dominantType = "logical";
  c5_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c5_info[34].fileLength = 454U;
  c5_info[34].fileTime1 = 1160446750U;
  c5_info[34].fileTime2 = 0U;
  c5_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[35].name = "eml_assert";
  c5_info[35].dominantType = "char";
  c5_info[35].resolved = "[B]eml_assert";
  c5_info[35].fileLength = 0U;
  c5_info[35].fileTime1 = 0U;
  c5_info[35].fileTime2 = 0U;
  c5_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[36].name = "isinteger";
  c5_info[36].dominantType = "double";
  c5_info[36].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c5_info[36].fileLength = 254U;
  c5_info[36].fileTime1 = 1160446620U;
  c5_info[36].fileTime2 = 0U;
  c5_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[37].name = "eml_numel";
  c5_info[37].dominantType = "double";
  c5_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[37].fileLength = 278U;
  c5_info[37].fileTime1 = 1163970802U;
  c5_info[37].fileTime2 = 0U;
  c5_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[38].name = "false";
  c5_info[38].dominantType = "";
  c5_info[38].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c5_info[38].fileLength = 631U;
  c5_info[38].fileTime1 = 1163970766U;
  c5_info[38].fileTime2 = 0U;
  c5_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[39].name = "ge";
  c5_info[39].dominantType = "double";
  c5_info[39].resolved = "[B]ge";
  c5_info[39].fileLength = 0U;
  c5_info[39].fileTime1 = 0U;
  c5_info[39].fileTime2 = 0U;
  c5_info[40].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[40].name = "floor";
  c5_info[40].dominantType = "double";
  c5_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c5_info[40].fileLength = 595U;
  c5_info[40].fileTime1 = 1163970736U;
  c5_info[40].fileTime2 = 0U;
  c5_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[41].name = "isempty";
  c5_info[41].dominantType = "logical";
  c5_info[41].resolved = "[B]isempty";
  c5_info[41].fileLength = 0U;
  c5_info[41].fileTime1 = 0U;
  c5_info[41].fileTime2 = 0U;
  c5_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[42].name = "isnumeric";
  c5_info[42].dominantType = "double";
  c5_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c5_info[42].fileLength = 250U;
  c5_info[42].fileTime1 = 1160446622U;
  ...
  c5_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[44].name = "eml_check_dim";
  c5_info[44].dominantType = "double";
  c5_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[44].fileLength = 1470U;
  c5_info[44].fileTime1 = 1177099718U;
  ...
  c5_info[45].fileLength = 791U;
  c5_info[45].fileTime1 = 1160446618U;
  c5_info[45].fileTime2 = 0U;
  c5_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[46].name = "le";
  c5_info[46].dominantType = "int32";
  c5_info[46].resolved = "[B]le";
  ...
  c5_info[48].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c5_info[48].fileLength = 769U;
  c5_info[48].fileTime1 = 1163970754U;
...
/* SFunction Glue Code */
void sf_c5_Pong_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Pong_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c5_Pong(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_Pong();
  initialize_c5_Pong();
}

static void sf_opaque_enable_c5_Pong(void *chartInstanceVar)
{
  enable_c5_Pong();
}

static void sf_opaque_disable_c5_Pong(void *chartInstanceVar)
{
  disable_c5_Pong();
}

static void sf_opaque_gateway_c5_Pong(void *chartInstanceVar)
{
  sf_c5_Pong();
}

static void sf_opaque_ext_mode_exec_c5_Pong(void *chartInstanceVar)
{
  ext_mode_exec_c5_Pong();
}

static void sf_opaque_terminate_c5_Pong(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c5_Pong(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Pong",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Pong",5,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Pong",5,2);
      sf_mark_chart_reusable_outputs(S,"Pong",5,3);
    }
    sf_set_rtw_dwork_info(S,"Pong",5);
...
static void mdlRTW_c5_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Pong", 5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_Pong(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Pong;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c5_Pong;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c5_Pong;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c5_Pong;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c5_Pong;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c5_Pong;
  chartInstance.chartInfo.mdlStart = mdlStart_c5_Pong;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Pong;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c5_Pong;
...
void c5_Pong_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Pong(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Pong(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c5_Pong_method_dispatcher.\n"
