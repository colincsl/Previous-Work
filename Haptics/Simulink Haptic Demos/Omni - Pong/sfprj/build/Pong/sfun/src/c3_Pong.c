...
#include "Pong_sfun_debug_macros.h"
...
static SFc3_PongInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_Pong(void);
static void initialize_params_c3_Pong(void);
static void enable_c3_Pong(void);
static void disable_c3_Pong(void);
static void ext_mode_exec_c3_Pong(void);
static void finalize_c3_Pong(void);
static void sf_c3_Pong(void);
...
static void initialize_c3_Pong(void)
{
  uint8_T *c3_is_active_c3_Pong;
  c3_is_active_c3_Pong = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c3_is_active_c3_Pong = 0U;
}
...
static void sf_c3_Pong(void)
{
  ...
  sf_debug_check_for_state_inconsistency(_PongMachineNumber_,
...
const mxArray *sf_c3_Pong_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[50])
{
  ...
  c3_info[0].name = "eml_is_float_class";
  c3_info[0].dominantType = "char";
  c3_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c3_info[0].fileLength = 273U;
  c3_info[0].fileTime1 = 1160446744U;
  c3_info[0].fileTime2 = 0U;
  c3_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[1].name = "eml_numel";
  c3_info[1].dominantType = "double";
  c3_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[1].fileLength = 278U;
  c3_info[1].fileTime1 = 1163970802U;
  c3_info[1].fileTime2 = 0U;
  c3_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[2].name = "isinteger";
  c3_info[2].dominantType = "double";
  c3_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c3_info[2].fileLength = 254U;
  c3_info[2].fileTime1 = 1160446620U;
  c3_info[2].fileTime2 = 0U;
  c3_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[3].name = "class";
  c3_info[3].dominantType = "char";
  c3_info[3].resolved = "[B]class";
  ...
  c3_info[4].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[4].fileLength = 2616U;
  c3_info[4].fileTime1 = 1163970698U;
  c3_info[4].fileTime2 = 0U;
  c3_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[5].name = "rdivide";
  c3_info[5].dominantType = "double";
  c3_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[5].fileLength = 4533U;
  c3_info[5].fileTime1 = 1177099748U;
  c3_info[5].fileTime2 = 0U;
  c3_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[6].name = "isempty";
  c3_info[6].dominantType = "double";
  c3_info[6].resolved = "[B]isempty";
  ...
  c3_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c3_info[7].fileLength = 236U;
  c3_info[7].fileTime1 = 1163970776U;
  c3_info[7].fileTime2 = 0U;
  c3_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[8].name = "numel";
  c3_info[8].dominantType = "double";
  c3_info[8].resolved = "[B]numel";
  ...
  c3_info[19].name = "le";
  c3_info[19].dominantType = "int32";
  c3_info[19].resolved = "[B]le";
  c3_info[19].fileLength = 0U;
  c3_info[19].fileTime1 = 0U;
  c3_info[19].fileTime2 = 0U;
  c3_info[20].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m/sumwork";
  c3_info[20].name = "isvector";
  c3_info[20].dominantType = "double";
  c3_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c3_info[20].fileLength = 284U;
  c3_info[20].fileTime1 = 1160446706U;
  c3_info[20].fileTime2 = 0U;
  c3_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[21].name = "isequal";
  c3_info[21].dominantType = "double";
  c3_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[21].fileLength = 2071U;
  c3_info[21].fileTime1 = 1163970770U;
  ...
  c3_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[23].name = "eml_check_dim";
  c3_info[23].dominantType = "double";
  c3_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[23].fileLength = 1470U;
  c3_info[23].fileTime1 = 1177099718U;
  c3_info[23].fileTime2 = 0U;
  c3_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[24].name = "eml_is_integer_class";
  c3_info[24].dominantType = "char";
  c3_info[24].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c3_info[24].fileLength = 462U;
  c3_info[24].fileTime1 = 1160446744U;
  ...
  c3_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[26].name = "eq";
  c3_info[26].dominantType = "double";
  c3_info[26].resolved = "[B]eq";
  ...
  c3_info[31].fileLength = 288U;
  c3_info[31].fileTime1 = 1163970798U;
  c3_info[31].fileTime2 = 0U;
  c3_info[32].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m/sumwork";
  c3_info[32].name = "cast";
  c3_info[32].dominantType = "double";
  c3_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c3_info[32].fileLength = 907U;
  c3_info[32].fileTime1 = 1160446618U;
  c3_info[32].fileTime2 = 0U;
  c3_info[33].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[33].name = "nargout";
  c3_info[33].dominantType = "";
  c3_info[33].resolved = "[B]nargout";
  ...
  c3_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[34].fileLength = 1031U;
  c3_info[34].fileTime1 = 1163970702U;
  c3_info[34].fileTime2 = 0U;
  c3_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[35].name = "size";
  c3_info[35].dominantType = "double";
  c3_info[35].resolved = "[B]size";
  ...
  c3_info[36].fileLength = 791U;
  c3_info[36].fileTime1 = 1160446618U;
  c3_info[36].fileTime2 = 0U;
  c3_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[37].name = "isreal";
  c3_info[37].dominantType = "double";
  c3_info[37].resolved = "[B]isreal";
  c3_info[37].fileLength = 0U;
  c3_info[37].fileTime1 = 0U;
  c3_info[37].fileTime2 = 0U;
  c3_info[38].context = "";
  c3_info[38].name = "mtimes";
  c3_info[38].dominantType = "double";
  c3_info[38].resolved = "[B]mtimes";
  ...
  c3_info[39].resolved = "[B]ne";
  c3_info[39].fileLength = 0U;
  c3_info[39].fileTime1 = 0U;
  c3_info[39].fileTime2 = 0U;
  c3_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[40].name = "int32";
  c3_info[40].dominantType = "double";
  c3_info[40].resolved = "[B]int32";
  c3_info[40].fileLength = 0U;
  c3_info[40].fileTime1 = 0U;
  c3_info[40].fileTime2 = 0U;
  c3_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[41].name = "false";
  c3_info[41].dominantType = "";
  c3_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c3_info[41].fileLength = 631U;
  c3_info[41].fileTime1 = 1163970766U;
  ...
  c3_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[43].name = "floor";
  c3_info[43].dominantType = "double";
  c3_info[43].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c3_info[43].fileLength = 595U;
  c3_info[43].fileTime1 = 1163970736U;
  c3_info[43].fileTime2 = 0U;
  c3_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[44].name = "length";
  c3_info[44].dominantType = "double";
  c3_info[44].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[44].fileLength = 347U;
  c3_info[44].fileTime1 = 1163970770U;
  ...
  c3_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[46].name = "true";
  c3_info[46].dominantType = "";
  c3_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[46].fileLength = 625U;
  c3_info[46].fileTime1 = 1163970786U;
  c3_info[46].fileTime2 = 0U;
  c3_info[47].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[47].name = "all";
  c3_info[47].dominantType = "logical";
  c3_info[47].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[47].fileLength = 2066U;
  c3_info[47].fileTime1 = 1166598650U;
  c3_info[47].fileTime2 = 0U;
  c3_info[48].context = "";
  c3_info[48].name = "mrdivide";
  c3_info[48].dominantType = "double";
  c3_info[48].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[48].fileLength = 653U;
  c3_info[48].fileTime1 = 1160446802U;
...
/* SFunction Glue Code */
void sf_c3_Pong_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Pong_get_autoinheritance_info(void)
{
 ...
 fullDebuggerInitialization)
{
  if(ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart(_PongMachineNumber_,
         3,
         1,
         1,
         2,
        ...
        if(chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_PongMachineNumber_,chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_PongMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_PongMachineNumber_,
           chartInstance.chartNumber,
           0,
           0,
           0);
    ...
    sf_debug_reset_current_state_configuration(_PongMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c3_Pong(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_Pong();
  initialize_c3_Pong();
}

static void sf_opaque_enable_c3_Pong(void *chartInstanceVar)
{
  enable_c3_Pong();
}

static void sf_opaque_disable_c3_Pong(void *chartInstanceVar)
{
  disable_c3_Pong();
}

static void sf_opaque_gateway_c3_Pong(void *chartInstanceVar)
{
  sf_c3_Pong();
}

static void sf_opaque_ext_mode_exec_c3_Pong(void *chartInstanceVar)
{
  ext_mode_exec_c3_Pong();
}

static void sf_opaque_terminate_c3_Pong(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c3_Pong(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Pong",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Pong",3,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Pong",3,1);
      sf_mark_chart_reusable_outputs(S,"Pong",3,1);
    }
    sf_set_rtw_dwork_info(S,"Pong",3);
...
static void mdlRTW_c3_Pong(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Pong", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_Pong(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Pong;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c3_Pong;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c3_Pong;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c3_Pong;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c3_Pong;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_Pong;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_Pong;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Pong;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c3_Pong;
...
void c3_Pong_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Pong(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Pong(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_Pong_method_dispatcher.\n"
