...
static SFc4_Force_RenderingInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_Force_Rendering(void);
static void initialize_params_c4_Force_Rendering(void);
static void enable_c4_Force_Rendering(void);
static void disable_c4_Force_Rendering(void);
static void finalize_c4_Force_Rendering(void);
...
/* SFunction Glue Code */
void sf_c4_Force_Rendering_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_Force_Rendering_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c4_Force_Rendering(void *chartInstanceVar)
{
  initialize_params_c4_Force_Rendering();
  initialize_c4_Force_Rendering();
}

static void sf_opaque_enable_c4_Force_Rendering(void *chartInstanceVar)
{
  enable_c4_Force_Rendering();
}

static void sf_opaque_disable_c4_Force_Rendering(void *chartInstanceVar)
{
  disable_c4_Force_Rendering();
}

static void sf_opaque_gateway_c4_Force_Rendering(void *chartInstanceVar)
{
  sf_c4_Force_Rendering();
}
...
static void mdlProcessParameters_c4_Force_Rendering(SimStruct *S)
{
  int i;
...
static void mdlRTW_c4_Force_Rendering(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Force_Rendering", 4);
...
void c4_Force_Rendering_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Force_Rendering(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Force_Rendering(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Force_Rendering(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c4_Force_Rendering_method_dispatcher.\n"
