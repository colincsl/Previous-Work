...
static SFc3_Force_RenderingInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_Force_Rendering(void);
static void initialize_params_c3_Force_Rendering(void);
static void enable_c3_Force_Rendering(void);
static void disable_c3_Force_Rendering(void);
static void ext_mode_exec_c3_Force_Rendering(void);
static void finalize_c3_Force_Rendering(void);
static void sf_c3_Force_Rendering(void);
...
static void initialize_c3_Force_Rendering(void)
{
  uint8_T *c3_is_active_c3_Force_Rendering;
  c3_is_active_c3_Force_Rendering = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c3_is_active_c3_Force_Rendering = 0U;
}
...
const mxArray *sf_c3_Force_Rendering_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[50])
{
  c3_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[0].name = "logical";
  c3_info[0].dominantType = "double";
  c3_info[0].resolved = "[B]logical";
  ...
  c3_info[1].name = "intmax";
  c3_info[1].dominantType = "char";
  c3_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[1].fileLength = 1575U;
  c3_info[1].fileTime1 = 1160446696U;
  c3_info[1].fileTime2 = 0U;
  c3_info[2].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[2].name = "le";
  c3_info[2].dominantType = "int32";
  c3_info[2].resolved = "[B]le";
  ...
  c3_info[3].name = "eml_is_float_class";
  c3_info[3].dominantType = "char";
  c3_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c3_info[3].fileLength = 273U;
  c3_info[3].fileTime1 = 1160446744U;
  c3_info[3].fileTime2 = 0U;
  c3_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[4].name = "eq";
  c3_info[4].dominantType = "double";
  c3_info[4].resolved = "[B]eq";
  ...
  c3_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[5].fileLength = 653U;
  c3_info[5].fileTime1 = 1160446802U;
  c3_info[5].fileTime2 = 0U;
  c3_info[6].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[6].name = "floor";
  c3_info[6].dominantType = "double";
  c3_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c3_info[6].fileLength = 595U;
  c3_info[6].fileTime1 = 1163970736U;
  c3_info[6].fileTime2 = 0U;
  c3_info[7].context = "";
  c3_info[7].name = "mtimes";
  c3_info[7].dominantType = "double";
  c3_info[7].resolved = "[B]mtimes";
  ...
  c3_info[8].fileLength = 907U;
  c3_info[8].fileTime1 = 1160446618U;
  ...
  c3_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[14].name = "int32";
  c3_info[14].dominantType = "double";
  c3_info[14].resolved = "[B]int32";
  ...
  c3_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c3_info[20].fileLength = 236U;
  c3_info[20].fileTime1 = 1163970776U;
  c3_info[20].fileTime2 = 0U;
  c3_info[21].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m/sumwork";
  c3_info[21].name = "isvector";
  c3_info[21].dominantType = "double";
  c3_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c3_info[21].fileLength = 284U;
  c3_info[21].fileTime1 = 1160446706U;
  ...
  c3_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[23].name = "size";
  c3_info[23].dominantType = "double";
  c3_info[23].resolved = "[B]size";
  c3_info[23].fileLength = 0U;
  c3_info[23].fileTime1 = 0U;
  c3_info[23].fileTime2 = 0U;
  c3_info[24].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c3_info[24].name = "ischar";
  c3_info[24].dominantType = "char";
  c3_info[24].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c3_info[24].fileLength = 244U;
  c3_info[24].fileTime1 = 1160446834U;
  ...
  c3_info[25].fileLength = 953U;
  c3_info[25].fileTime1 = 1160446742U;
  ...
  c3_info[29].name = "isempty";
  c3_info[29].dominantType = "double";
  c3_info[29].resolved = "[B]isempty";
  ...
  c3_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[34].name = "eml_numel";
  c3_info[34].dominantType = "double";
  c3_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[34].fileLength = 278U;
  c3_info[34].fileTime1 = 1163970802U;
  c3_info[34].fileTime2 = 0U;
  c3_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[35].name = "false";
  c3_info[35].dominantType = "";
  c3_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c3_info[35].fileLength = 631U;
  c3_info[35].fileTime1 = 1163970766U;
  c3_info[35].fileTime2 = 0U;
  c3_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[36].name = "all";
  c3_info[36].dominantType = "logical";
  c3_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[36].fileLength = 2066U;
  c3_info[36].fileTime1 = 1166598650U;
  c3_info[36].fileTime2 = 0U;
  c3_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[37].name = "length";
  c3_info[37].dominantType = "double";
  c3_info[37].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[37].fileLength = 347U;
  c3_info[37].fileTime1 = 1163970770U;
  c3_info[37].fileTime2 = 0U;
  c3_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[38].name = "eml_isa_uint";
  c3_info[38].dominantType = "double";
  c3_info[38].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c3_info[38].fileLength = 288U;
  c3_info[38].fileTime1 = 1163970798U;
  c3_info[38].fileTime2 = 0U;
  c3_info[39].context = "";
  c3_info[39].name = "abs";
  c3_info[39].dominantType = "double";
  c3_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[39].fileLength = 1031U;
  c3_info[39].fileTime1 = 1163970702U;
  c3_info[39].fileTime2 = 0U;
  c3_info[40].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[40].name = "ne";
  c3_info[40].dominantType = "double";
  c3_info[40].resolved = "[B]ne";
  c3_info[40].fileLength = 0U;
  c3_info[40].fileTime1 = 0U;
  c3_info[40].fileTime2 = 0U;
  c3_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[41].name = "isscalar";
  c3_info[41].dominantType = "double";
  c3_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[41].fileLength = 243U;
  c3_info[41].fileTime1 = 1160446704U;
  c3_info[41].fileTime2 = 0U;
  c3_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[42].name = "isfloat";
  c3_info[42].dominantType = "double";
  c3_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c3_info[42].fileLength = 182U;
  c3_info[42].fileTime1 = 1160446620U;
  c3_info[42].fileTime2 = 0U;
  c3_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m/sumwork";
  c3_info[43].name = "plus";
  c3_info[43].dominantType = "double";
  c3_info[43].resolved = "[B]plus";
  c3_info[43].fileLength = 0U;
  c3_info[43].fileTime1 = 0U;
  c3_info[43].fileTime2 = 0U;
  c3_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[44].name = "eml_nonsingleton_dim";
  c3_info[44].dominantType = "logical";
  c3_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[44].fileLength = 454U;
  c3_info[44].fileTime1 = 1160446750U;
  ...
  c3_info[45].fileLength = 791U;
  c3_info[45].fileTime1 = 1160446618U;
  c3_info[45].fileTime2 = 0U;
  c3_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[46].name = "lt";
  c3_info[46].dominantType = "double";
  c3_info[46].resolved = "[B]lt";
  c3_info[46].fileLength = 0U;
  c3_info[46].fileTime1 = 0U;
  c3_info[46].fileTime2 = 0U;
  c3_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[47].name = "true";
  c3_info[47].dominantType = "";
  c3_info[47].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[47].fileLength = 625U;
  c3_info[47].fileTime1 = 1163970786U;
  c3_info[47].fileTime2 = 0U;
  c3_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[48].name = "isequal";
  c3_info[48].dominantType = "double";
  c3_info[48].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[48].fileLength = 2071U;
  c3_info[48].fileTime1 = 1163970770U;
  c3_info[48].fileTime2 = 0U;
  c3_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[49].name = "numel";
  c3_info[49].dominantType = "double";
  c3_info[49].resolved = "[B]numel";
...
/* SFunction Glue Code */
void sf_c3_Force_Rendering_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Force_Rendering_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c3_Force_Rendering(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_Force_Rendering();
  initialize_c3_Force_Rendering();
}

static void sf_opaque_enable_c3_Force_Rendering(void *chartInstanceVar)
{
  enable_c3_Force_Rendering();
}

static void sf_opaque_disable_c3_Force_Rendering(void *chartInstanceVar)
{
  disable_c3_Force_Rendering();
}

static void sf_opaque_gateway_c3_Force_Rendering(void *chartInstanceVar)
{
  sf_c3_Force_Rendering();
}

static void sf_opaque_ext_mode_exec_c3_Force_Rendering(void *chartInstanceVar)
{
  ext_mode_exec_c3_Force_Rendering();
}

static void sf_opaque_terminate_c3_Force_Rendering(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c3_Force_Rendering();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Force_Rendering(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Force_Rendering(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Force_Rendering",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Force_Rendering",3,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Force_Rendering",3,1);
      sf_mark_chart_reusable_outputs(S,"Force_Rendering",3,1);
    }
    sf_set_rtw_dwork_info(S,"Force_Rendering",3);
...
static void mdlRTW_c3_Force_Rendering(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Force_Rendering", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_Force_Rendering(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Force_Rendering;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c3_Force_Rendering;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c3_Force_Rendering;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c3_Force_Rendering;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c3_Force_Rendering;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_Force_Rendering;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_Force_Rendering;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Force_Rendering;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_Force_Rendering;
...
void c3_Force_Rendering_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Force_Rendering(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Force_Rendering(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Force_Rendering(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_Force_Rendering_method_dispatcher.\n"
