...
static SFc5_Force_RenderingInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c5_Force_Rendering(void);
static void initialize_params_c5_Force_Rendering(void);
static void enable_c5_Force_Rendering(void);
static void disable_c5_Force_Rendering(void);
static void ext_mode_exec_c5_Force_Rendering(void);
static void finalize_c5_Force_Rendering(void);
static void sf_c5_Force_Rendering(void);
...
static void initialize_c5_Force_Rendering(void)
{
  uint8_T *c5_is_active_c5_Force_Rendering;
  c5_is_active_c5_Force_Rendering = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_Force_Rendering = 0U;
}
...
const mxArray *sf_c5_Force_Rendering_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[49])
{
  c5_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[0].name = "isinteger";
  c5_info[0].dominantType = "double";
  c5_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c5_info[0].fileLength = 254U;
  c5_info[0].fileTime1 = 1160446620U;
  c5_info[0].fileTime2 = 0U;
  c5_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[1].name = "eq";
  ...
  c5_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[2].name = "size";
  c5_info[2].dominantType = "double";
  c5_info[2].resolved = "[B]size";
  ...
  c5_info[4].name = "isempty";
  c5_info[4].dominantType = "logical";
  c5_info[4].resolved = "[B]isempty";
  ...
  c5_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[6].fileLength = 1575U;
  c5_info[6].fileTime1 = 1160446696U;
  ...
  c5_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[9].name = "ge";
  c5_info[9].dominantType = "double";
  c5_info[9].resolved = "[B]ge";
  c5_info[9].fileLength = 0U;
  c5_info[9].fileTime1 = 0U;
  c5_info[9].fileTime2 = 0U;
  c5_info[10].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[10].name = "length";
  c5_info[10].dominantType = "double";
  c5_info[10].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[10].fileLength = 347U;
  c5_info[10].fileTime1 = 1163970770U;
  c5_info[10].fileTime2 = 0U;
  c5_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  ...
  c5_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[13].name = "numel";
  c5_info[13].dominantType = "double";
  c5_info[13].resolved = "[B]numel";
  ...
  c5_info[14].resolved = "[B]ne";
  c5_info[14].fileLength = 0U;
  c5_info[14].fileTime1 = 0U;
  c5_info[14].fileTime2 = 0U;
  c5_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[15].name = "rdivide";
  c5_info[15].dominantType = "double";
  c5_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[15].fileLength = 4533U;
  c5_info[15].fileTime1 = 1177099748U;
  c5_info[15].fileTime2 = 0U;
  c5_info[16].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[16].name = "nargout";
  c5_info[16].dominantType = "";
  c5_info[16].resolved = "[B]nargout";
  c5_info[16].fileLength = 0U;
  c5_info[16].fileTime1 = 0U;
  c5_info[16].fileTime2 = 0U;
  c5_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c5_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[19].name = "eml_is_integer_class";
  c5_info[19].dominantType = "char";
  c5_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c5_info[19].fileLength = 462U;
  c5_info[19].fileTime1 = 1160446744U;
  c5_info[19].fileTime2 = 0U;
  c5_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[20].name = "isfloat";
  c5_info[20].dominantType = "double";
  c5_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c5_info[20].fileLength = 182U;
  c5_info[20].fileTime1 = 1160446620U;
  c5_info[20].fileTime2 = 0U;
  c5_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[21].name = "eml_assert";
  c5_info[21].dominantType = "char";
  c5_info[21].resolved = "[B]eml_assert";
  ...
  c5_info[22].fileLength = 244U;
  c5_info[22].fileTime1 = 1160446834U;
  c5_info[22].fileTime2 = 0U;
  c5_info[23].context = "";
  c5_info[23].name = "sin";
  c5_info[23].dominantType = "double";
  c5_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c5_info[23].fileLength = 769U;
  c5_info[23].fileTime1 = 1163970754U;
  ...
  c5_info[24].fileLength = 953U;
  c5_info[24].fileTime1 = 1160446742U;
  ...
  c5_info[26].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[26].fileLength = 772U;
  c5_info[26].fileTime1 = 1163970724U;
  c5_info[26].fileTime2 = 0U;
  c5_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[27].name = "lt";
  c5_info[27].dominantType = "double";
  c5_info[27].resolved = "[B]lt";
  c5_info[27].fileLength = 0U;
  c5_info[27].fileTime1 = 0U;
  c5_info[27].fileTime2 = 0U;
  c5_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  ...
  c5_info[29].context = "";
  c5_info[29].name = "mrdivide";
  c5_info[29].dominantType = "double";
  c5_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[29].fileLength = 653U;
  c5_info[29].fileTime1 = 1160446802U;
  c5_info[29].fileTime2 = 0U;
  c5_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[30].name = "eml_is_float_class";
  c5_info[30].dominantType = "char";
  c5_info[30].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c5_info[30].fileLength = 273U;
  c5_info[30].fileTime1 = 1160446744U;
  ...
  c5_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[31].fileLength = 2066U;
  c5_info[31].fileTime1 = 1166598650U;
  c5_info[31].fileTime2 = 0U;
  c5_info[32].context = "";
  c5_info[32].name = "cross";
  c5_info[32].dominantType = "double";
  c5_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[32].fileLength = 2893U;
  c5_info[32].fileTime1 = 1163970838U;
  c5_info[32].fileTime2 = 0U;
  c5_info[33].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[33].name = "floor";
  c5_info[33].dominantType = "double";
  c5_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c5_info[33].fileLength = 595U;
  c5_info[33].fileTime1 = 1163970736U;
  c5_info[33].fileTime2 = 0U;
  c5_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[34].name = "eml_numel";
  c5_info[34].dominantType = "double";
  c5_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[34].fileLength = 278U;
  c5_info[34].fileTime1 = 1163970802U;
  ...
  c5_info[35].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[35].fileLength = 243U;
  c5_info[35].fileTime1 = 1160446704U;
  c5_info[35].fileTime2 = 0U;
  c5_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[36].name = "nargin";
  c5_info[36].dominantType = "";
  c5_info[36].resolved = "[B]nargin";
  c5_info[36].fileLength = 0U;
  c5_info[36].fileTime1 = 0U;
  c5_info[36].fileTime2 = 0U;
  c5_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[37].name = "isvector";
  c5_info[37].dominantType = "double";
  c5_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c5_info[37].fileLength = 284U;
  c5_info[37].fileTime1 = 1160446706U;
  c5_info[37].fileTime2 = 0U;
  c5_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[38].name = "eml_check_dim";
  c5_info[38].dominantType = "double";
  c5_info[38].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[38].fileLength = 1470U;
  c5_info[38].fileTime1 = 1177099718U;
  c5_info[38].fileTime2 = 0U;
  c5_info[39].context = "";
  c5_info[39].name = "ctranspose";
  c5_info[39].dominantType = "double";
  c5_info[39].resolved = "[B]ctranspose";
  ...
  c5_info[40].fileLength = 791U;
  c5_info[40].fileTime1 = 1160446618U;
  c5_info[40].fileTime2 = 0U;
  c5_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[41].name = "false";
  c5_info[41].dominantType = "";
  c5_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c5_info[41].fileLength = 631U;
  c5_info[41].fileTime1 = 1163970766U;
  c5_info[41].fileTime2 = 0U;
  c5_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[42].name = "ndims";
  c5_info[42].dominantType = "double";
  c5_info[42].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c5_info[42].fileLength = 236U;
  c5_info[42].fileTime1 = 1163970776U;
  c5_info[42].fileTime2 = 0U;
  c5_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[43].name = "not";
  c5_info[43].dominantType = "logical";
  c5_info[43].resolved = "[B]not";
  c5_info[43].fileLength = 0U;
  c5_info[43].fileTime1 = 0U;
  c5_info[43].fileTime2 = 0U;
  c5_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[44].name = "isnumeric";
  c5_info[44].dominantType = "double";
  c5_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c5_info[44].fileLength = 250U;
  c5_info[44].fileTime1 = 1160446622U;
  c5_info[44].fileTime2 = 0U;
  c5_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[45].name = "gt";
  c5_info[45].dominantType = "double";
  c5_info[45].resolved = "[B]gt";
  c5_info[45].fileLength = 0U;
  c5_info[45].fileTime1 = 0U;
  c5_info[45].fileTime2 = 0U;
  c5_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[46].name = "islogical";
  c5_info[46].dominantType = "logical";
  c5_info[46].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/islogical.m";
  c5_info[46].fileLength = 186U;
  c5_info[46].fileTime1 = 1160446622U;
  c5_info[46].fileTime2 = 0U;
  c5_info[47].context = "";
  c5_info[47].name = "minus";
  c5_info[47].dominantType = "double";
  c5_info[47].resolved = "[B]minus";
  c5_info[47].fileLength = 0U;
  c5_info[47].fileTime1 = 0U;
  c5_info[47].fileTime2 = 0U;
  c5_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[48].name = "int32";
  c5_info[48].dominantType = "double";
  c5_info[48].resolved = "[B]int32";
...
/* SFunction Glue Code */
void sf_c5_Force_Rendering_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Force_Rendering_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c5_Force_Rendering(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_Force_Rendering();
  initialize_c5_Force_Rendering();
}

static void sf_opaque_enable_c5_Force_Rendering(void *chartInstanceVar)
{
  enable_c5_Force_Rendering();
}

static void sf_opaque_disable_c5_Force_Rendering(void *chartInstanceVar)
{
  disable_c5_Force_Rendering();
}

static void sf_opaque_gateway_c5_Force_Rendering(void *chartInstanceVar)
{
  sf_c5_Force_Rendering();
}

static void sf_opaque_ext_mode_exec_c5_Force_Rendering(void *chartInstanceVar)
{
  ext_mode_exec_c5_Force_Rendering();
}

static void sf_opaque_terminate_c5_Force_Rendering(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c5_Force_Rendering();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Force_Rendering(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Force_Rendering(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Force_Rendering",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Force_Rendering",5,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Force_Rendering",5,2);
      sf_mark_chart_reusable_outputs(S,"Force_Rendering",5,3);
    }
    sf_set_rtw_dwork_info(S,"Force_Rendering",5);
...
static void mdlRTW_c5_Force_Rendering(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Force_Rendering", 5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_Force_Rendering(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Force_Rendering;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c5_Force_Rendering;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c5_Force_Rendering;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c5_Force_Rendering;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c5_Force_Rendering;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c5_Force_Rendering;
  chartInstance.chartInfo.mdlStart = mdlStart_c5_Force_Rendering;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Force_Rendering;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_Force_Rendering;
...
void c5_Force_Rendering_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Force_Rendering(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Force_Rendering(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Force_Rendering(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c5_Force_Rendering_method_dispatcher.\n"
