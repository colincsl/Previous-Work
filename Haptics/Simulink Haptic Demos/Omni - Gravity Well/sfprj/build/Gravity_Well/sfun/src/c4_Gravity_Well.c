...
static SFc4_Gravity_WellInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_Gravity_Well(void);
static void initialize_params_c4_Gravity_Well(void);
static void enable_c4_Gravity_Well(void);
static void disable_c4_Gravity_Well(void);
static void finalize_c4_Gravity_Well(void);
static void sf_c4_Gravity_Well(void);
...
/* SFunction Glue Code */
void sf_c4_Gravity_Well_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_Gravity_Well_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c4_Gravity_Well(void *chartInstanceVar)
{
  initialize_params_c4_Gravity_Well();
  initialize_c4_Gravity_Well();
}

static void sf_opaque_enable_c4_Gravity_Well(void *chartInstanceVar)
{
  enable_c4_Gravity_Well();
}

static void sf_opaque_disable_c4_Gravity_Well(void *chartInstanceVar)
{
  disable_c4_Gravity_Well();
}

static void sf_opaque_gateway_c4_Gravity_Well(void *chartInstanceVar)
{
  sf_c4_Gravity_Well();
}
...
static void mdlProcessParameters_c4_Gravity_Well(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Gravity_Well",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Gravity_Well",4,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Gravity_Well",4,1);
      sf_mark_chart_reusable_outputs(S,"Gravity_Well",4,1);
    }
    sf_set_rtw_dwork_info(S,"Gravity_Well",4);
...
static void mdlRTW_c4_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Gravity_Well", 4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c4_Gravity_Well(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c4_Gravity_Well;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c4_Gravity_Well;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c4_Gravity_Well;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c4_Gravity_Well;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c4_Gravity_Well;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c4_Gravity_Well;
  chartInstance.chartInfo.mdlStart = mdlStart_c4_Gravity_Well;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_Gravity_Well;
...
void c4_Gravity_Well_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Gravity_Well(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Gravity_Well(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Gravity_Well(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c4_Gravity_Well_method_dispatcher.\n"
