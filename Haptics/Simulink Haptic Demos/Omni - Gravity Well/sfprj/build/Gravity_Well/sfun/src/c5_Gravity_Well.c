...
static SFc5_Gravity_WellInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c5_Gravity_Well(void);
static void initialize_params_c5_Gravity_Well(void);
static void enable_c5_Gravity_Well(void);
static void disable_c5_Gravity_Well(void);
static void ext_mode_exec_c5_Gravity_Well(void);
static void finalize_c5_Gravity_Well(void);
static void sf_c5_Gravity_Well(void);
...
static void initialize_c5_Gravity_Well(void)
{
  uint8_T *c5_is_active_c5_Gravity_Well;
  c5_is_active_c5_Gravity_Well = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_Gravity_Well = 0U;
}
...
const mxArray *sf_c5_Gravity_Well_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[49])
{
  ...
  c5_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[0].fileLength = 791U;
  c5_info[0].fileTime1 = 1160446618U;
  c5_info[0].fileTime2 = 0U;
  c5_info[1].context = "";
  c5_info[1].name = "mrdivide";
  c5_info[1].dominantType = "double";
  c5_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[1].fileLength = 653U;
  c5_info[1].fileTime1 = 1160446802U;
  c5_info[1].fileTime2 = 0U;
  c5_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  ...
  c5_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[3].name = "isnumeric";
  c5_info[3].dominantType = "double";
  c5_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c5_info[3].fileLength = 250U;
  c5_info[3].fileTime1 = 1160446622U;
  ...
  c5_info[12].fileLength = 953U;
  c5_info[12].fileTime1 = 1160446742U;
  c5_info[12].fileTime2 = 0U;
  c5_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[13].name = "eml_is_float_class";
  c5_info[13].dominantType = "char";
  c5_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c5_info[13].fileLength = 273U;
  c5_info[13].fileTime1 = 1160446744U;
  c5_info[13].fileTime2 = 0U;
  c5_info[14].context = "";
  c5_info[14].name = "ctranspose";
  c5_info[14].dominantType = "double";
  c5_info[14].resolved = "[B]ctranspose";
  c5_info[14].fileLength = 0U;
  c5_info[14].fileTime1 = 0U;
  c5_info[14].fileTime2 = 0U;
  c5_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[15].name = "isinteger";
  c5_info[15].dominantType = "double";
  c5_info[15].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c5_info[15].fileLength = 254U;
  c5_info[15].fileTime1 = 1160446620U;
  c5_info[15].fileTime2 = 0U;
  c5_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[16].name = "strcmp";
  c5_info[16].dominantType = "char";
  c5_info[16].resolved = "[B]strcmp";
  ...
  c5_info[18].fileLength = 244U;
  c5_info[18].fileTime1 = 1160446834U;
  ...
  c5_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[20].name = "eml_nonsingleton_dim";
  c5_info[20].dominantType = "logical";
  c5_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c5_info[20].fileLength = 454U;
  c5_info[20].fileTime1 = 1160446750U;
  c5_info[20].fileTime2 = 0U;
  c5_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[21].name = "isscalar";
  c5_info[21].dominantType = "double";
  c5_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[21].fileLength = 243U;
  c5_info[21].fileTime1 = 1160446704U;
  c5_info[21].fileTime2 = 0U;
  c5_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[22].name = "all";
  c5_info[22].dominantType = "logical";
  c5_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[22].fileLength = 2066U;
  c5_info[22].fileTime1 = 1166598650U;
  c5_info[22].fileTime2 = 0U;
  c5_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[23].name = "eq";
  c5_info[23].dominantType = "double";
  c5_info[23].resolved = "[B]eq";
  c5_info[23].fileLength = 0U;
  c5_info[23].fileTime1 = 0U;
  c5_info[23].fileTime2 = 0U;
  c5_info[24].context = "";
  c5_info[24].name = "uminus";
  c5_info[24].dominantType = "double";
  c5_info[24].resolved = "[B]uminus";
  ...
  c5_info[25].resolved = "[B]le";
  c5_info[25].fileLength = 0U;
  c5_info[25].fileTime1 = 0U;
  c5_info[25].fileTime2 = 0U;
  c5_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[26].name = "isreal";
  c5_info[26].dominantType = "double";
  c5_info[26].resolved = "[B]isreal";
  ...
  c5_info[28].name = "ndims";
  c5_info[28].dominantType = "double";
  c5_info[28].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c5_info[28].fileLength = 236U;
  c5_info[28].fileTime1 = 1163970776U;
  c5_info[28].fileTime2 = 0U;
  c5_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[29].name = "true";
  c5_info[29].dominantType = "";
  c5_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[29].fileLength = 625U;
  c5_info[29].fileTime1 = 1163970786U;
  ...
  c5_info[32].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[32].fileLength = 772U;
  c5_info[32].fileTime1 = 1163970724U;
  ...
  c5_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c5_info[34].fileLength = 769U;
  c5_info[34].fileTime1 = 1163970754U;
  c5_info[34].fileTime2 = 0U;
  c5_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[35].name = "logical";
  c5_info[35].dominantType = "double";
  c5_info[35].resolved = "[B]logical";
  ...
  c5_info[38].fileLength = 1575U;
  c5_info[38].fileTime1 = 1160446696U;
  c5_info[38].fileTime2 = 0U;
  c5_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[39].name = "isfloat";
  c5_info[39].dominantType = "double";
  c5_info[39].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c5_info[39].fileLength = 182U;
  c5_info[39].fileTime1 = 1160446620U;
  c5_info[39].fileTime2 = 0U;
  c5_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[40].name = "islogical";
  c5_info[40].dominantType = "logical";
  c5_info[40].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/islogical.m";
  c5_info[40].fileLength = 186U;
  c5_info[40].fileTime1 = 1160446622U;
  ...
  c5_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[42].name = "numel";
  c5_info[42].dominantType = "double";
  c5_info[42].resolved = "[B]numel";
  c5_info[42].fileLength = 0U;
  c5_info[42].fileTime1 = 0U;
  c5_info[42].fileTime2 = 0U;
  c5_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[43].name = "eml_check_dim";
  c5_info[43].dominantType = "double";
  c5_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[43].fileLength = 1470U;
  c5_info[43].fileTime1 = 1177099718U;
  c5_info[43].fileTime2 = 0U;
  c5_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[44].name = "eml_numel";
  c5_info[44].dominantType = "double";
  c5_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[44].fileLength = 278U;
  c5_info[44].fileTime1 = 1163970802U;
  c5_info[44].fileTime2 = 0U;
  c5_info[45].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[45].name = "ge";
  c5_info[45].dominantType = "double";
  c5_info[45].resolved = "[B]ge";
  c5_info[45].fileLength = 0U;
  c5_info[45].fileTime1 = 0U;
  c5_info[45].fileTime2 = 0U;
  c5_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
...
/* SFunction Glue Code */
void sf_c5_Gravity_Well_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Gravity_Well_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c5_Gravity_Well(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_Gravity_Well();
  initialize_c5_Gravity_Well();
}

static void sf_opaque_enable_c5_Gravity_Well(void *chartInstanceVar)
{
  enable_c5_Gravity_Well();
}

static void sf_opaque_disable_c5_Gravity_Well(void *chartInstanceVar)
{
  disable_c5_Gravity_Well();
}

static void sf_opaque_gateway_c5_Gravity_Well(void *chartInstanceVar)
{
  sf_c5_Gravity_Well();
}

static void sf_opaque_ext_mode_exec_c5_Gravity_Well(void *chartInstanceVar)
{
  ext_mode_exec_c5_Gravity_Well();
}

static void sf_opaque_terminate_c5_Gravity_Well(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c5_Gravity_Well();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Gravity_Well(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Gravity_Well",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Gravity_Well",5,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Gravity_Well",5,2);
      sf_mark_chart_reusable_outputs(S,"Gravity_Well",5,3);
    }
    sf_set_rtw_dwork_info(S,"Gravity_Well",5);
...
static void mdlRTW_c5_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Gravity_Well", 5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_Gravity_Well(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Gravity_Well;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c5_Gravity_Well;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c5_Gravity_Well;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c5_Gravity_Well;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c5_Gravity_Well;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c5_Gravity_Well;
  chartInstance.chartInfo.mdlStart = mdlStart_c5_Gravity_Well;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Gravity_Well;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c5_Gravity_Well;
...
void c5_Gravity_Well_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Gravity_Well(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Gravity_Well(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Gravity_Well(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c5_Gravity_Well_method_dispatcher.\n"
