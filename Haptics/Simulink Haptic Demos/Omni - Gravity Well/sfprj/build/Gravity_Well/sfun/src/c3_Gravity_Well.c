...
static SFc3_Gravity_WellInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_Gravity_Well(void);
static void initialize_params_c3_Gravity_Well(void);
static void enable_c3_Gravity_Well(void);
static void disable_c3_Gravity_Well(void);
static void ext_mode_exec_c3_Gravity_Well(void);
static void finalize_c3_Gravity_Well(void);
static void sf_c3_Gravity_Well(void);
...
static void initialize_c3_Gravity_Well(void)
{
  uint8_T *c3_is_active_c3_Gravity_Well;
  c3_is_active_c3_Gravity_Well = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c3_is_active_c3_Gravity_Well = 0U;
}
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[50])
{
  ...
  c3_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[2].name = "rdivide";
  c3_info[2].dominantType = "double";
  c3_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[2].fileLength = 4533U;
  c3_info[2].fileTime1 = 1177099748U;
  c3_info[2].fileTime2 = 0U;
  c3_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[3].name = "not";
  c3_info[3].dominantType = "logical";
  c3_info[3].resolved = "[B]not";
  ...
  c3_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[5].name = "int32";
  c3_info[5].dominantType = "double";
  c3_info[5].resolved = "[B]int32";
  ...
  c3_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[8].fileLength = 1575U;
  c3_info[8].fileTime1 = 1160446696U;
  c3_info[8].fileTime2 = 0U;
  c3_info[9].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[9].name = "ne";
  c3_info[9].dominantType = "double";
  c3_info[9].resolved = "[B]ne";
  c3_info[9].fileLength = 0U;
  c3_info[9].fileTime1 = 0U;
  c3_info[9].fileTime2 = 0U;
  c3_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[10].name = "eml_nonsingleton_dim";
  c3_info[10].dominantType = "logical";
  c3_info[10].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[10].fileLength = 454U;
  c3_info[10].fileTime1 = 1160446750U;
  c3_info[10].fileTime2 = 0U;
  c3_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[11].name = "logical";
  c3_info[11].dominantType = "double";
  c3_info[11].resolved = "[B]logical";
  ...
  c3_info[12].name = "ischar";
  c3_info[12].dominantType = "char";
  c3_info[12].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c3_info[12].fileLength = 244U;
  c3_info[12].fileTime1 = 1160446834U;
  c3_info[12].fileTime2 = 0U;
  c3_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  ...
  c3_info[14].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[14].name = "floor";
  c3_info[14].dominantType = "double";
  c3_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c3_info[14].fileLength = 595U;
  c3_info[14].fileTime1 = 1163970736U;
  c3_info[14].fileTime2 = 0U;
  c3_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[15].name = "eml_assert";
  c3_info[15].dominantType = "char";
  c3_info[15].resolved = "[B]eml_assert";
  ...
  c3_info[16].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[16].fileLength = 1031U;
  c3_info[16].fileTime1 = 1163970702U;
  c3_info[16].fileTime2 = 0U;
  c3_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[17].name = "nargin";
  c3_info[17].dominantType = "";
  c3_info[17].resolved = "[B]nargin";
  ...
  c3_info[18].fileLength = 907U;
  c3_info[18].fileTime1 = 1160446618U;
  c3_info[18].fileTime2 = 0U;
  c3_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[19].name = "lt";
  c3_info[19].dominantType = "double";
  c3_info[19].resolved = "[B]lt";
  ...
  c3_info[20].fileLength = 953U;
  c3_info[20].fileTime1 = 1160446742U;
  ...
  c3_info[22].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m/sumwork";
  c3_info[22].name = "isvector";
  c3_info[22].dominantType = "double";
  c3_info[22].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c3_info[22].fileLength = 284U;
  c3_info[22].fileTime1 = 1160446706U;
  c3_info[22].fileTime2 = 0U;
  c3_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[23].name = "isequal";
  c3_info[23].dominantType = "double";
  c3_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[23].fileLength = 2071U;
  c3_info[23].fileTime1 = 1163970770U;
  c3_info[23].fileTime2 = 0U;
  c3_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[24].name = "islogical";
  c3_info[24].dominantType = "double";
  c3_info[24].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/islogical.m";
  c3_info[24].fileLength = 186U;
  c3_info[24].fileTime1 = 1160446622U;
  c3_info[24].fileTime2 = 0U;
  c3_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[25].name = "eq";
  c3_info[25].dominantType = "double";
  c3_info[25].resolved = "[B]eq";
  c3_info[25].fileLength = 0U;
  c3_info[25].fileTime1 = 0U;
  c3_info[25].fileTime2 = 0U;
  c3_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[26].name = "eml_numel";
  c3_info[26].dominantType = "double";
  c3_info[26].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[26].fileLength = 278U;
  c3_info[26].fileTime1 = 1163970802U;
  c3_info[26].fileTime2 = 0U;
  c3_info[27].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[27].name = "all";
  c3_info[27].dominantType = "logical";
  c3_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[27].fileLength = 2066U;
  c3_info[27].fileTime1 = 1166598650U;
  c3_info[27].fileTime2 = 0U;
  c3_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[28].name = "eml_is_float_class";
  c3_info[28].dominantType = "char";
  c3_info[28].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c3_info[28].fileLength = 273U;
  c3_info[28].fileTime1 = 1160446744U;
  c3_info[28].fileTime2 = 0U;
  c3_info[29].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c3_info[29].name = "double";
  c3_info[29].dominantType = "double";
  c3_info[29].resolved = "[B]double";
  ...
  c3_info[32].fileLength = 254U;
  c3_info[32].fileTime1 = 1160446620U;
  c3_info[32].fileTime2 = 0U;
  c3_info[33].context = "";
  c3_info[33].name = "mtimes";
  c3_info[33].dominantType = "double";
  c3_info[33].resolved = "[B]mtimes";
  c3_info[33].fileLength = 0U;
  c3_info[33].fileTime1 = 0U;
  c3_info[33].fileTime2 = 0U;
  c3_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[34].name = "true";
  c3_info[34].dominantType = "";
  c3_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[34].fileLength = 625U;
  c3_info[34].fileTime1 = 1163970786U;
  c3_info[34].fileTime2 = 0U;
  c3_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[35].name = "class";
  c3_info[35].dominantType = "char";
  c3_info[35].resolved = "[B]class";
  ...
  c3_info[39].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[39].name = "ndims";
  c3_info[39].dominantType = "double";
  c3_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c3_info[39].fileLength = 236U;
  c3_info[39].fileTime1 = 1163970776U;
  c3_info[39].fileTime2 = 0U;
  c3_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[40].name = "false";
  c3_info[40].dominantType = "";
  c3_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c3_info[40].fileLength = 631U;
  c3_info[40].fileTime1 = 1163970766U;
  c3_info[40].fileTime2 = 0U;
  c3_info[41].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[41].name = "nargout";
  c3_info[41].dominantType = "";
  c3_info[41].resolved = "[B]nargout";
  ...
  c3_info[42].resolved = "[B]gt";
  c3_info[42].fileLength = 0U;
  c3_info[42].fileTime1 = 0U;
  c3_info[42].fileTime2 = 0U;
  c3_info[43].context = "";
  c3_info[43].name = "mrdivide";
  c3_info[43].dominantType = "double";
  c3_info[43].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[43].fileLength = 653U;
  c3_info[43].fileTime1 = 1160446802U;
  c3_info[43].fileTime2 = 0U;
  c3_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[44].name = "isempty";
  c3_info[44].dominantType = "double";
  c3_info[44].resolved = "[B]isempty";
  ...
  c3_info[45].name = "isscalar";
  c3_info[45].dominantType = "double";
  c3_info[45].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[45].fileLength = 243U;
  c3_info[45].fileTime1 = 1160446704U;
  ...
  c3_info[47].resolved = "[B]le";
  c3_info[47].fileLength = 0U;
  c3_info[47].fileTime1 = 0U;
  c3_info[47].fileTime2 = 0U;
  c3_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[48].name = "eml_check_dim";
  c3_info[48].dominantType = "double";
  c3_info[48].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[48].fileLength = 1470U;
  c3_info[48].fileTime1 = 1177099718U;
  c3_info[48].fileTime2 = 0U;
  c3_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[49].name = "ge";
  c3_info[49].dominantType = "double";
  c3_info[49].resolved = "[B]ge";
...
/* SFunction Glue Code */
void sf_c3_Gravity_Well_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Gravity_Well_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c3_Gravity_Well(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_Gravity_Well();
  initialize_c3_Gravity_Well();
}

static void sf_opaque_enable_c3_Gravity_Well(void *chartInstanceVar)
{
  enable_c3_Gravity_Well();
}

static void sf_opaque_disable_c3_Gravity_Well(void *chartInstanceVar)
{
  disable_c3_Gravity_Well();
}

static void sf_opaque_gateway_c3_Gravity_Well(void *chartInstanceVar)
{
  sf_c3_Gravity_Well();
}

static void sf_opaque_ext_mode_exec_c3_Gravity_Well(void *chartInstanceVar)
{
  ext_mode_exec_c3_Gravity_Well();
}

static void sf_opaque_terminate_c3_Gravity_Well(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c3_Gravity_Well();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Gravity_Well(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Gravity_Well",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Gravity_Well",3,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Gravity_Well",3,1);
      sf_mark_chart_reusable_outputs(S,"Gravity_Well",3,1);
    }
    sf_set_rtw_dwork_info(S,"Gravity_Well",3);
...
static void mdlRTW_c3_Gravity_Well(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Gravity_Well", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_Gravity_Well(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Gravity_Well;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c3_Gravity_Well;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c3_Gravity_Well;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c3_Gravity_Well;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c3_Gravity_Well;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_Gravity_Well;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_Gravity_Well;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Gravity_Well;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c3_Gravity_Well;
...
void c3_Gravity_Well_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Gravity_Well(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Gravity_Well(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Gravity_Well(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_Gravity_Well_method_dispatcher.\n"
