...
static SFc3_Puncture_Through_WallInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_Puncture_Through_Wall(void);
static void initialize_params_c3_Puncture_Through_Wall(void);
static void enable_c3_Puncture_Through_Wall(void);
static void disable_c3_Puncture_Through_Wall(void);
static void ext_mode_exec_c3_Puncture_Through_Wall(void);
static void finalize_c3_Puncture_Through_Wall(void);
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[50])
{
  ...
  c3_info[0].name = "floor";
  c3_info[0].dominantType = "double";
  c3_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c3_info[0].fileLength = 595U;
  c3_info[0].fileTime1 = 1163970736U;
  c3_info[0].fileTime2 = 0U;
  c3_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[1].name = "isempty";
  c3_info[1].dominantType = "double";
  c3_info[1].resolved = "[B]isempty";
  ...
  c3_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[7].name = "isfloat";
  c3_info[7].dominantType = "double";
  c3_info[7].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c3_info[7].fileLength = 182U;
  c3_info[7].fileTime1 = 1160446620U;
  ...
  c3_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c3_info[8].fileLength = 236U;
  c3_info[8].fileTime1 = 1163970776U;
  c3_info[8].fileTime2 = 0U;
  c3_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[9].name = "eml_isa_uint";
  c3_info[9].dominantType = "double";
  c3_info[9].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c3_info[9].fileLength = 288U;
  c3_info[9].fileTime1 = 1163970798U;
  c3_info[9].fileTime2 = 0U;
  c3_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c3_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[12].name = "eq";
  c3_info[12].dominantType = "double";
  c3_info[12].resolved = "[B]eq";
  c3_info[12].fileLength = 0U;
  c3_info[12].fileTime1 = 0U;
  c3_info[12].fileTime2 = 0U;
  c3_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[13].name = "nargin";
  c3_info[13].dominantType = "";
  c3_info[13].resolved = "[B]nargin";
  ...
  c3_info[14].name = "ischar";
  c3_info[14].dominantType = "char";
  c3_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c3_info[14].fileLength = 244U;
  c3_info[14].fileTime1 = 1160446834U;
  ...
  c3_info[15].fileLength = 791U;
  c3_info[15].fileTime1 = 1160446618U;
  c3_info[15].fileTime2 = 0U;
  c3_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[16].name = "isequal";
  c3_info[16].dominantType = "double";
  c3_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[16].fileLength = 2071U;
  c3_info[16].fileTime1 = 1163970770U;
  c3_info[16].fileTime2 = 0U;
  c3_info[17].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[17].name = "ne";
  c3_info[17].dominantType = "double";
  c3_info[17].resolved = "[B]ne";
  ...
  c3_info[18].name = "isreal";
  c3_info[18].dominantType = "double";
  c3_info[18].resolved = "[B]isreal";
  c3_info[18].fileLength = 0U;
  c3_info[18].fileTime1 = 0U;
  c3_info[18].fileTime2 = 0U;
  c3_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[19].name = "ge";
  c3_info[19].dominantType = "double";
  c3_info[19].resolved = "[B]ge";
  ...
  c3_info[20].name = "length";
  c3_info[20].dominantType = "double";
  c3_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[20].fileLength = 347U;
  c3_info[20].fileTime1 = 1163970770U;
  ...
  c3_info[22].name = "double";
  c3_info[22].dominantType = "double";
  c3_info[22].resolved = "[B]double";
  ...
  c3_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[23].fileLength = 625U;
  c3_info[23].fileTime1 = 1163970786U;
  c3_info[23].fileTime2 = 0U;
  c3_info[24].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[24].name = "intmax";
  c3_info[24].dominantType = "char";
  c3_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[24].fileLength = 1575U;
  c3_info[24].fileTime1 = 1160446696U;
  c3_info[24].fileTime2 = 0U;
  c3_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[25].name = "numel";
  c3_info[25].dominantType = "double";
  c3_info[25].resolved = "[B]numel";
  c3_info[25].fileLength = 0U;
  c3_info[25].fileTime1 = 0U;
  c3_info[25].fileTime2 = 0U;
  c3_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[26].name = "logical";
  c3_info[26].dominantType = "double";
  c3_info[26].resolved = "[B]logical";
  c3_info[26].fileLength = 0U;
  c3_info[26].fileTime1 = 0U;
  c3_info[26].fileTime2 = 0U;
  c3_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[27].name = "lt";
  c3_info[27].dominantType = "double";
  c3_info[27].resolved = "[B]lt";
  ...
  c3_info[28].resolved = "[B]mtimes";
  c3_info[28].fileLength = 0U;
  c3_info[28].fileTime1 = 0U;
  c3_info[28].fileTime2 = 0U;
  c3_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[29].name = "false";
  c3_info[29].dominantType = "";
  c3_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c3_info[29].fileLength = 631U;
  c3_info[29].fileTime1 = 1163970766U;
  c3_info[29].fileTime2 = 0U;
  c3_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[30].name = "eml_numel";
  c3_info[30].dominantType = "double";
  c3_info[30].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[30].fileLength = 278U;
  c3_info[30].fileTime1 = 1163970802U;
  ...
  c3_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[33].name = "isinteger";
  c3_info[33].dominantType = "double";
  c3_info[33].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c3_info[33].fileLength = 254U;
  c3_info[33].fileTime1 = 1160446620U;
  c3_info[33].fileTime2 = 0U;
  c3_info[34].context = "";
  c3_info[34].name = "sum";
  c3_info[34].dominantType = "double";
  c3_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[34].fileLength = 2616U;
  c3_info[34].fileTime1 = 1163970698U;
  c3_info[34].fileTime2 = 0U;
  c3_info[35].context = "";
  c3_info[35].name = "abs";
  c3_info[35].dominantType = "double";
  c3_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[35].fileLength = 1031U;
  c3_info[35].fileTime1 = 1163970702U;
  c3_info[35].fileTime2 = 0U;
  c3_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[36].name = "isscalar";
  c3_info[36].dominantType = "double";
  c3_info[36].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[36].fileLength = 243U;
  c3_info[36].fileTime1 = 1160446704U;
  c3_info[36].fileTime2 = 0U;
  c3_info[37].context = "";
  c3_info[37].name = "mrdivide";
  c3_info[37].dominantType = "double";
  c3_info[37].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[37].fileLength = 653U;
  c3_info[37].fileTime1 = 1160446802U;
  ...
  c3_info[39].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[39].name = "eml_index_class";
  c3_info[39].dominantType = "";
  c3_info[39].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c3_info[39].fileLength = 953U;
  c3_info[39].fileTime1 = 1160446742U;
  c3_info[39].fileTime2 = 0U;
  c3_info[40].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[40].name = "nargout";
  c3_info[40].dominantType = "";
  c3_info[40].resolved = "[B]nargout";
  c3_info[40].fileLength = 0U;
  c3_info[40].fileTime1 = 0U;
  c3_info[40].fileTime2 = 0U;
  c3_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[41].name = "rdivide";
  c3_info[41].dominantType = "double";
  c3_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[41].fileLength = 4533U;
  c3_info[41].fileTime1 = 1177099748U;
  c3_info[41].fileTime2 = 0U;
  c3_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[42].name = "eml_is_float_class";
  c3_info[42].dominantType = "char";
  c3_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c3_info[42].fileLength = 273U;
  c3_info[42].fileTime1 = 1160446744U;
  c3_info[42].fileTime2 = 0U;
  c3_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[43].name = "eml_is_integer_class";
  c3_info[43].dominantType = "char";
  c3_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c3_info[43].fileLength = 462U;
  c3_info[43].fileTime1 = 1160446744U;
  c3_info[43].fileTime2 = 0U;
  c3_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[44].name = "int32";
  c3_info[44].dominantType = "double";
  c3_info[44].resolved = "[B]int32";
  c3_info[44].fileLength = 0U;
  c3_info[44].fileTime1 = 0U;
  c3_info[44].fileTime2 = 0U;
  c3_info[45].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[45].name = "eml_nonsingleton_dim";
  c3_info[45].dominantType = "logical";
  c3_info[45].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[45].fileLength = 454U;
  c3_info[45].fileTime1 = 1160446750U;
  c3_info[45].fileTime2 = 0U;
  c3_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[46].name = "all";
  c3_info[46].dominantType = "logical";
  c3_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[46].fileLength = 2066U;
  c3_info[46].fileTime1 = 1166598650U;
  c3_info[46].fileTime2 = 0U;
  c3_info[47].context = "";
  c3_info[47].name = "zeros";
  c3_info[47].dominantType = "double";
  c3_info[47].resolved = "[B]zeros";
...
/* SFunction Glue Code */
void sf_c3_Puncture_Through_Wall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Puncture_Through_Wall_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c3_Puncture_Through_Wall(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_Puncture_Through_Wall();
  initialize_c3_Puncture_Through_Wall();
}

static void sf_opaque_enable_c3_Puncture_Through_Wall(void *chartInstanceVar)
{
  enable_c3_Puncture_Through_Wall();
}

static void sf_opaque_disable_c3_Puncture_Through_Wall(void *chartInstanceVar)
{
  disable_c3_Puncture_Through_Wall();
}

static void sf_opaque_gateway_c3_Puncture_Through_Wall(void *chartInstanceVar)
{
  sf_c3_Puncture_Through_Wall();
}

static void sf_opaque_ext_mode_exec_c3_Puncture_Through_Wall(void
 *chartInstanceVar)
{
  ext_mode_exec_c3_Puncture_Through_Wall();
}
...
static void mdlProcessParameters_c3_Puncture_Through_Wall(SimStruct *S)
{
  int i;
...
static void mdlRTW_c3_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Puncture_Through_Wall", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_Puncture_Through_Wall(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Puncture_Through_Wall;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c3_Puncture_Through_Wall;
...
void c3_Puncture_Through_Wall_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Puncture_Through_Wall(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_Puncture_Through_Wall_method_dispatcher.\n"
