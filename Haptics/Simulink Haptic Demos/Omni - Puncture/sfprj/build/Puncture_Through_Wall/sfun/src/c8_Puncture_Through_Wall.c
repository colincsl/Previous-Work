...
static SFc8_Puncture_Through_WallInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_Puncture_Through_Wall(void);
static void initialize_params_c8_Puncture_Through_Wall(void);
static void enable_c8_Puncture_Through_Wall(void);
static void disable_c8_Puncture_Through_Wall(void);
static void ext_mode_exec_c8_Puncture_Through_Wall(void);
static void finalize_c8_Puncture_Through_Wall(void);
static void sf_c8_Puncture_Through_Wall(void);
...
static void initialize_c8_Puncture_Through_Wall(void)
{
  uint8_T *c8_is_active_c8_Puncture_Through_Wall;
  c8_is_active_c8_Puncture_Through_Wall = (uint8_T *)ssGetDWork(chartInstance.S,
   1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_Puncture_Through_Wall = 0U;
}
...
const mxArray *sf_c8_Puncture_Through_Wall_get_eml_resolved_functions_info(void)
{
...
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[23])
{
  c8_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[0].name = "eml_numel";
  c8_info[0].dominantType = "double";
  c8_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c8_info[0].fileLength = 278U;
  c8_info[0].fileTime1 = 1163970802U;
  ...
  c8_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[2].name = "eq";
  c8_info[2].dominantType = "double";
  c8_info[2].resolved = "[B]eq";
  ...
  c8_info[6].name = "ischar";
  c8_info[6].dominantType = "char";
  c8_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c8_info[6].fileLength = 244U;
  c8_info[6].fileTime1 = 1160446834U;
  c8_info[6].fileTime2 = 0U;
  c8_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[7].name = "strcmp";
  c8_info[7].dominantType = "char";
  c8_info[7].resolved = "[B]strcmp";
  c8_info[7].fileLength = 0U;
  c8_info[7].fileTime1 = 0U;
  c8_info[7].fileTime2 = 0U;
  c8_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[8].name = "size";
  ...
  c8_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[9].name = "class";
  c8_info[9].dominantType = "char";
  c8_info[9].resolved = "[B]class";
  ...
  c8_info[10].fileLength = 791U;
  c8_info[10].fileTime1 = 1160446618U;
  c8_info[10].fileTime2 = 0U;
  c8_info[11].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c8_info[11].name = "length";
  c8_info[11].dominantType = "double";
  c8_info[11].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[11].fileLength = 347U;
  c8_info[11].fileTime1 = 1163970770U;
  c8_info[11].fileTime2 = 0U;
  c8_info[12].context = "";
  c8_info[12].name = "pi";
  c8_info[12].dominantType = "";
  c8_info[12].resolved = "[B]pi";
  c8_info[12].fileLength = 0U;
  c8_info[12].fileTime1 = 0U;
  c8_info[12].fileTime2 = 0U;
  c8_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[13].name = "eml_is_float_class";
  c8_info[13].dominantType = "char";
  c8_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c8_info[13].fileLength = 273U;
  c8_info[13].fileTime1 = 1160446744U;
  c8_info[13].fileTime2 = 0U;
  c8_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[14].name = "rdivide";
  c8_info[14].dominantType = "double";
  c8_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[14].fileLength = 4533U;
  c8_info[14].fileTime1 = 1177099748U;
  c8_info[14].fileTime2 = 0U;
  c8_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c8_info[15].name = "eml_is_integer_class";
  c8_info[15].dominantType = "char";
  c8_info[15].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c8_info[15].fileLength = 462U;
  c8_info[15].fileTime1 = 1160446744U;
  c8_info[15].fileTime2 = 0U;
  c8_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[16].name = "isscalar";
  c8_info[16].dominantType = "double";
  c8_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c8_info[16].fileLength = 243U;
  c8_info[16].fileTime1 = 1160446704U;
  c8_info[16].fileTime2 = 0U;
  c8_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[17].name = "ge";
  c8_info[17].dominantType = "double";
  c8_info[17].resolved = "[B]ge";
  c8_info[17].fileLength = 0U;
  c8_info[17].fileTime1 = 0U;
  c8_info[17].fileTime2 = 0U;
  c8_info[18].context = "";
  c8_info[18].name = "mrdivide";
  c8_info[18].dominantType = "double";
  c8_info[18].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[18].fileLength = 653U;
  c8_info[18].fileTime1 = 1160446802U;
  c8_info[18].fileTime2 = 0U;
  c8_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[19].name = "isinteger";
  c8_info[19].dominantType = "double";
  c8_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c8_info[19].fileLength = 254U;
  c8_info[19].fileTime1 = 1160446620U;
  c8_info[19].fileTime2 = 0U;
  c8_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c8_info[20].name = "numel";
  c8_info[20].dominantType = "double";
  c8_info[20].resolved = "[B]numel";
  ...
  c8_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[22].name = "isnumeric";
  c8_info[22].dominantType = "double";
  c8_info[22].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c8_info[22].fileLength = 250U;
  c8_info[22].fileTime1 = 1160446622U;
...
/* SFunction Glue Code */
void sf_c8_Puncture_Through_Wall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Puncture_Through_Wall_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c8_Puncture_Through_Wall(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_Puncture_Through_Wall();
  initialize_c8_Puncture_Through_Wall();
}

static void sf_opaque_enable_c8_Puncture_Through_Wall(void *chartInstanceVar)
{
  enable_c8_Puncture_Through_Wall();
}

static void sf_opaque_disable_c8_Puncture_Through_Wall(void *chartInstanceVar)
{
  disable_c8_Puncture_Through_Wall();
}

static void sf_opaque_gateway_c8_Puncture_Through_Wall(void *chartInstanceVar)
{
  sf_c8_Puncture_Through_Wall();
}

static void sf_opaque_ext_mode_exec_c8_Puncture_Through_Wall(void
 *chartInstanceVar)
{
  ext_mode_exec_c8_Puncture_Through_Wall();
}

static void sf_opaque_terminate_c8_Puncture_Through_Wall(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c8_Puncture_Through_Wall();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Puncture_Through_Wall(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Puncture_Through_Wall",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Puncture_Through_Wall",8,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Puncture_Through_Wall",8,1);
      sf_mark_chart_reusable_outputs(S,"Puncture_Through_Wall",8,1);
    }
    sf_set_rtw_dwork_info(S,"Puncture_Through_Wall",8);
...
static void mdlRTW_c8_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Puncture_Through_Wall", 8);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c8_Puncture_Through_Wall(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Puncture_Through_Wall;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c8_Puncture_Through_Wall;
...
void c8_Puncture_Through_Wall_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Puncture_Through_Wall(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c8_Puncture_Through_Wall_method_dispatcher.\n"
