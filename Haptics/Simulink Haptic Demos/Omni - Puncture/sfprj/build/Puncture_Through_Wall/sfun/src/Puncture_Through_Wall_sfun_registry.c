...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_Puncture_Through_Wall_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_Puncture_Through_Wall_process_check_sum_call(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
{
  extern unsigned int sf_Puncture_Through_Wall_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_Puncture_Through_Wall_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_Puncture_Through_Wall_get_eml_resolved_functions_info(
  ...
  if(strcmp(machineName, "Puncture_Through_Wall") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return
    sf_Puncture_Through_Wall_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Puncture_Through_Wall_method_dispatcher(SimStruct *S,
...
{
  if(!strcmp(machineName,"Puncture_Through_Wall")) {
    return(sf_Puncture_Through_Wall_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void Puncture_Through_Wall_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    Puncture_Through_Wall_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void Puncture_Through_Wall_initializer(void);
extern void Puncture_Through_Wall_register_exported_symbols(SimStruct* S);
extern void Puncture_Through_Wall_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Puncture_Through_Wall_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      Puncture_Through_Wall_debug_initialize();
    }
    Puncture_Through_Wall_initializer();
  }
  return;
}
