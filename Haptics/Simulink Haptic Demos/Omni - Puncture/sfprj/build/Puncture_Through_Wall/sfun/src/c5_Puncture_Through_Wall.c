...
#include "Puncture_Through_Wall_sfun_debug_macros.h"
...
static SFc5_Puncture_Through_WallInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c5_Puncture_Through_Wall(void);
static void initialize_params_c5_Puncture_Through_Wall(void);
static void enable_c5_Puncture_Through_Wall(void);
static void disable_c5_Puncture_Through_Wall(void);
static void ext_mode_exec_c5_Puncture_Through_Wall(void);
static void finalize_c5_Puncture_Through_Wall(void);
static void sf_c5_Puncture_Through_Wall(void);
...
static void initialize_c5_Puncture_Through_Wall(void)
{
  uint8_T *c5_is_active_c5_Puncture_Through_Wall;
  c5_is_active_c5_Puncture_Through_Wall = (uint8_T *)ssGetDWork(chartInstance.S,
   1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_Puncture_Through_Wall = 0U;
}
...
const mxArray *sf_c5_Puncture_Through_Wall_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[49])
{
  ...
  c5_info[0].name = "not";
  c5_info[0].dominantType = "logical";
  c5_info[0].resolved = "[B]not";
  ...
  c5_info[1].name = "nargout";
  c5_info[1].dominantType = "";
  c5_info[1].resolved = "[B]nargout";
  ...
  c5_info[2].name = "ndims";
  c5_info[2].dominantType = "double";
  c5_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c5_info[2].fileLength = 236U;
  c5_info[2].fileTime1 = 1163970776U;
  c5_info[2].fileTime2 = 0U;
  c5_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[3].name = "lt";
  c5_info[3].dominantType = "double";
  c5_info[3].resolved = "[B]lt";
  c5_info[3].fileLength = 0U;
  c5_info[3].fileTime1 = 0U;
  c5_info[3].fileTime2 = 0U;
  c5_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[4].name = "true";
  c5_info[4].dominantType = "";
  c5_info[4].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[4].fileLength = 625U;
  c5_info[4].fileTime1 = 1163970786U;
  c5_info[4].fileTime2 = 0U;
  c5_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[5].name = "eml_numel";
  c5_info[5].dominantType = "double";
  c5_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c5_info[5].fileLength = 278U;
  c5_info[5].fileTime1 = 1163970802U;
  c5_info[5].fileTime2 = 0U;
  c5_info[6].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c5_info[6].name = "isa";
  c5_info[6].dominantType = "double";
  c5_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[6].fileLength = 791U;
  c5_info[6].fileTime1 = 1160446618U;
  c5_info[6].fileTime2 = 0U;
  c5_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[7].name = "class";
  c5_info[7].dominantType = "char";
  c5_info[7].resolved = "[B]class";
  c5_info[7].fileLength = 0U;
  c5_info[7].fileTime1 = 0U;
  c5_info[7].fileTime2 = 0U;
  c5_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  ...
  c5_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[9].name = "strcmp";
  c5_info[9].dominantType = "char";
  c5_info[9].resolved = "[B]strcmp";
  c5_info[9].fileLength = 0U;
  c5_info[9].fileTime1 = 0U;
  c5_info[9].fileTime2 = 0U;
  c5_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c5_info[10].name = "logical";
  c5_info[10].dominantType = "double";
  c5_info[10].resolved = "[B]logical";
  c5_info[10].fileLength = 0U;
  c5_info[10].fileTime1 = 0U;
  c5_info[10].fileTime2 = 0U;
  c5_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[11].name = "eq";
  ...
  c5_info[12].context = "";
  c5_info[12].name = "uminus";
  c5_info[12].dominantType = "double";
  c5_info[12].resolved = "[B]uminus";
  ...
  c5_info[13].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[13].fileLength = 653U;
  c5_info[13].fileTime1 = 1160446802U;
  c5_info[13].fileTime2 = 0U;
  c5_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[14].name = "rdivide";
  c5_info[14].dominantType = "double";
  c5_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[14].fileLength = 4533U;
  c5_info[14].fileTime1 = 1177099748U;
  c5_info[14].fileTime2 = 0U;
  c5_info[15].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c5_info[15].name = "ne";
  c5_info[15].dominantType = "double";
  c5_info[15].resolved = "[B]ne";
  ...
  c5_info[20].fileLength = 953U;
  c5_info[20].fileTime1 = 1160446742U;
  c5_info[20].fileTime2 = 0U;
  c5_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[21].name = "isvector";
  c5_info[21].dominantType = "double";
  c5_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c5_info[21].fileLength = 284U;
  c5_info[21].fileTime1 = 1160446706U;
  c5_info[21].fileTime2 = 0U;
  c5_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  ...
  c5_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[23].name = "nargin";
  c5_info[23].dominantType = "";
  c5_info[23].resolved = "[B]nargin";
  c5_info[23].fileLength = 0U;
  c5_info[23].fileTime1 = 0U;
  c5_info[23].fileTime2 = 0U;
  c5_info[24].context = "";
  c5_info[24].name = "ctranspose";
  c5_info[24].dominantType = "double";
  c5_info[24].resolved = "[B]ctranspose";
  ...
  c5_info[25].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[25].fileLength = 1575U;
  c5_info[25].fileTime1 = 1160446696U;
  c5_info[25].fileTime2 = 0U;
  c5_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c5_info[26].fileLength = 273U;
  c5_info[26].fileTime1 = 1160446744U;
  ...
  c5_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[28].name = "isscalar";
  c5_info[28].dominantType = "double";
  c5_info[28].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[28].fileLength = 243U;
  c5_info[28].fileTime1 = 1160446704U;
  c5_info[28].fileTime2 = 0U;
  c5_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c5_info[29].name = "int32";
  c5_info[29].dominantType = "double";
  c5_info[29].resolved = "[B]int32";
  c5_info[29].fileLength = 0U;
  c5_info[29].fileTime1 = 0U;
  c5_info[29].fileTime2 = 0U;
  c5_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c5_info[30].name = "all";
  c5_info[30].dominantType = "logical";
  c5_info[30].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[30].fileLength = 2066U;
  c5_info[30].fileTime1 = 1166598650U;
  c5_info[30].fileTime2 = 0U;
  c5_info[31].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[31].name = "length";
  c5_info[31].dominantType = "double";
  c5_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c5_info[31].fileLength = 347U;
  c5_info[31].fileTime1 = 1163970770U;
  c5_info[31].fileTime2 = 0U;
  c5_info[32].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c5_info[32].name = "gt";
  c5_info[32].dominantType = "double";
  c5_info[32].resolved = "[B]gt";
  ...
  c5_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c5_info[33].fileLength = 769U;
  c5_info[33].fileTime1 = 1163970754U;
  c5_info[33].fileTime2 = 0U;
  c5_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[34].name = "false";
  c5_info[34].dominantType = "";
  c5_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c5_info[34].fileLength = 631U;
  c5_info[34].fileTime1 = 1163970766U;
  ...
  c5_info[35].fileLength = 244U;
  c5_info[35].fileTime1 = 1160446834U;
  c5_info[35].fileTime2 = 0U;
  c5_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[36].name = "le";
  c5_info[36].dominantType = "int32";
  c5_info[36].resolved = "[B]le";
  c5_info[36].fileLength = 0U;
  c5_info[36].fileTime1 = 0U;
  c5_info[36].fileTime2 = 0U;
  c5_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[37].name = "isinteger";
  c5_info[37].dominantType = "double";
  c5_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c5_info[37].fileLength = 254U;
  c5_info[37].fileTime1 = 1160446620U;
  c5_info[37].fileTime2 = 0U;
  c5_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[38].name = "eml_assert";
  c5_info[38].dominantType = "char";
  c5_info[38].resolved = "[B]eml_assert";
  c5_info[38].fileLength = 0U;
  c5_info[38].fileTime1 = 0U;
  c5_info[38].fileTime2 = 0U;
  c5_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[39].name = "eml_check_dim";
  c5_info[39].dominantType = "double";
  c5_info[39].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c5_info[39].fileLength = 1470U;
  c5_info[39].fileTime1 = 1177099718U;
  c5_info[39].fileTime2 = 0U;
  c5_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[40].name = "eml_nonsingleton_dim";
  c5_info[40].dominantType = "logical";
  c5_info[40].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c5_info[40].fileLength = 454U;
  c5_info[40].fileTime1 = 1160446750U;
  c5_info[40].fileTime2 = 0U;
  c5_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c5_info[41].name = "isnumeric";
  c5_info[41].dominantType = "double";
  c5_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c5_info[41].fileLength = 250U;
  c5_info[41].fileTime1 = 1160446622U;
  c5_info[41].fileTime2 = 0U;
  c5_info[42].context = "";
  c5_info[42].name = "minus";
  c5_info[42].dominantType = "double";
  c5_info[42].resolved = "[B]minus";
  c5_info[42].fileLength = 0U;
  c5_info[42].fileTime1 = 0U;
  c5_info[42].fileTime2 = 0U;
  c5_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c5_info[43].name = "eml_is_integer_class";
  c5_info[43].dominantType = "char";
  c5_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c5_info[43].fileLength = 462U;
  c5_info[43].fileTime1 = 1160446744U;
  c5_info[43].fileTime2 = 0U;
  c5_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c5_info[44].name = "ge";
  c5_info[44].dominantType = "double";
  c5_info[44].resolved = "[B]ge";
  ...
  c5_info[45].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c5_info[45].fileLength = 595U;
  c5_info[45].fileTime1 = 1163970736U;
  c5_info[45].fileTime2 = 0U;
  c5_info[46].context = "";
  c5_info[46].name = "cos";
  c5_info[46].dominantType = "double";
  c5_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c5_info[46].fileLength = 772U;
  c5_info[46].fileTime1 = 1163970724U;
  c5_info[46].fileTime2 = 0U;
  c5_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c5_info[47].name = "islogical";
  c5_info[47].dominantType = "logical";
  c5_info[47].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/islogical.m";
  c5_info[47].fileLength = 186U;
  c5_info[47].fileTime1 = 1160446622U;
  c5_info[47].fileTime2 = 0U;
  c5_info[48].context = "";
  c5_info[48].name = "pi";
  c5_info[48].dominantType = "";
  c5_info[48].resolved = "[B]pi";
...
/* SFunction Glue Code */
void sf_c5_Puncture_Through_Wall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Puncture_Through_Wall_get_autoinheritance_info(void)
{
 ...
 fullDebuggerInitialization)
{
  if(ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent =
          sf_debug_initialize_chart(_Puncture_Through_WallMachineNumber_,
         5,
         1,
         1,
         5,
        ...
        if(chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_Puncture_Through_WallMachineNumber_,chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_Puncture_Through_WallMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_Puncture_Through_WallMachineNumber_,
           chartInstance.chartNumber,
           0,
           0,
           0);
    ...
    sf_debug_reset_current_state_configuration(_Puncture_Through_WallMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c5_Puncture_Through_Wall(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_Puncture_Through_Wall();
  initialize_c5_Puncture_Through_Wall();
}

static void sf_opaque_enable_c5_Puncture_Through_Wall(void *chartInstanceVar)
{
  enable_c5_Puncture_Through_Wall();
}

static void sf_opaque_disable_c5_Puncture_Through_Wall(void *chartInstanceVar)
{
  disable_c5_Puncture_Through_Wall();
}

static void sf_opaque_gateway_c5_Puncture_Through_Wall(void *chartInstanceVar)
{
  sf_c5_Puncture_Through_Wall();
}

static void sf_opaque_ext_mode_exec_c5_Puncture_Through_Wall(void
 *chartInstanceVar)
{
  ext_mode_exec_c5_Puncture_Through_Wall();
}

static void sf_opaque_terminate_c5_Puncture_Through_Wall(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c5_Puncture_Through_Wall();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Puncture_Through_Wall(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Puncture_Through_Wall",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Puncture_Through_Wall",5,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Puncture_Through_Wall",5,2);
      sf_mark_chart_reusable_outputs(S,"Puncture_Through_Wall",5,3);
    }
    sf_set_rtw_dwork_info(S,"Puncture_Through_Wall",5);
...
static void mdlRTW_c5_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Puncture_Through_Wall", 5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_Puncture_Through_Wall(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlStart = mdlStart_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Puncture_Through_Wall;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_Puncture_Through_Wall;
...
void c5_Puncture_Through_Wall_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Puncture_Through_Wall(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c5_Puncture_Through_Wall_method_dispatcher.\n"
