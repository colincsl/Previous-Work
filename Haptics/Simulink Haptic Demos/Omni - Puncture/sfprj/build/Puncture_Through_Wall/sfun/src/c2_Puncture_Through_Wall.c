...
static SFc2_Puncture_Through_WallInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_Puncture_Through_Wall(void);
static void initialize_params_c2_Puncture_Through_Wall(void);
static void enable_c2_Puncture_Through_Wall(void);
static void disable_c2_Puncture_Through_Wall(void);
static void ext_mode_exec_c2_Puncture_Through_Wall(void);
static void finalize_c2_Puncture_Through_Wall(void);
static void sf_c2_Puncture_Through_Wall(void);
...
static void initialize_c2_Puncture_Through_Wall(void)
{
  uint8_T *c2_is_active_c2_Puncture_Through_Wall;
  c2_is_active_c2_Puncture_Through_Wall = (uint8_T *)ssGetDWork(chartInstance.S,
   1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c2_is_active_c2_Puncture_Through_Wall = 0U;
}
...
const mxArray *sf_c2_Puncture_Through_Wall_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[38])
{
  c2_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c2_info[0].name = "eml_is_float_class";
  c2_info[0].dominantType = "char";
  c2_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c2_info[0].fileLength = 273U;
  c2_info[0].fileTime1 = 1160446744U;
  ...
  c2_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[2].name = "isfloat";
  c2_info[2].dominantType = "double";
  c2_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c2_info[2].fileLength = 182U;
  c2_info[2].fileTime1 = 1160446620U;
  c2_info[2].fileTime2 = 0U;
  c2_info[3].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c2_info[3].name = "ischar";
  c2_info[3].dominantType = "char";
  c2_info[3].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c2_info[3].fileLength = 244U;
  c2_info[3].fileTime1 = 1160446834U;
  ...
  c2_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c2_info[5].fileLength = 791U;
  c2_info[5].fileTime1 = 1160446618U;
  c2_info[5].fileTime2 = 0U;
  c2_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[6].name = "eml_assert";
  c2_info[6].dominantType = "char";
  c2_info[6].resolved = "[B]eml_assert";
  c2_info[6].fileLength = 0U;
  c2_info[6].fileTime1 = 0U;
  c2_info[6].fileTime2 = 0U;
  c2_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c2_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[8].name = "uminus";
  c2_info[8].dominantType = "double";
  c2_info[8].resolved = "[B]uminus";
  ...
  c2_info[10].fileLength = 1496U;
  c2_info[10].fileTime1 = 1163970774U;
  c2_info[10].fileTime2 = 0U;
  c2_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c2_info[11].name = "eml_is_integer_class";
  c2_info[11].dominantType = "char";
  c2_info[11].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c2_info[11].fileLength = 462U;
  c2_info[11].fileTime1 = 1160446744U;
  c2_info[11].fileTime2 = 0U;
  c2_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[12].name = "isnumeric";
  c2_info[12].dominantType = "double";
  c2_info[12].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c2_info[12].fileLength = 250U;
  c2_info[12].fileTime1 = 1160446622U;
  c2_info[12].fileTime2 = 0U;
  c2_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[13].name = "eml_isa_uint";
  c2_info[13].dominantType = "double";
  c2_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c2_info[13].fileLength = 288U;
  c2_info[13].fileTime1 = 1163970798U;
  ...
  c2_info[15].fileLength = 186U;
  c2_info[15].fileTime1 = 1160446622U;
  c2_info[15].fileTime2 = 0U;
  c2_info[16].context = "";
  c2_info[16].name = "le";
  c2_info[16].dominantType = "double";
  c2_info[16].resolved = "[B]le";
  ...
  c2_info[18].name = "nargin";
  c2_info[18].dominantType = "";
  c2_info[18].resolved = "[B]nargin";
  ...
  c2_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[20].name = "eml_numel";
  c2_info[20].dominantType = "double";
  c2_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c2_info[20].fileLength = 278U;
  c2_info[20].fileTime1 = 1163970802U;
  ...
  c2_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[22].name = "isnan";
  c2_info[22].dominantType = "double";
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[22].fileLength = 514U;
  c2_info[22].fileTime1 = 1160446704U;
  ...
  c2_info[25].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[25].fileLength = 1031U;
  c2_info[25].fileTime1 = 1163970702U;
  ...
  c2_info[27].name = "length";
  c2_info[27].dominantType = "double";
  c2_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[27].fileLength = 347U;
  c2_info[27].fileTime1 = 1163970770U;
  ...
  c2_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[29].name = "isscalar";
  c2_info[29].dominantType = "double";
  c2_info[29].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c2_info[29].fileLength = 243U;
  c2_info[29].fileTime1 = 1160446704U;
  c2_info[29].fileTime2 = 0U;
  c2_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c2_info[30].name = "numel";
  c2_info[30].dominantType = "double";
  c2_info[30].resolved = "[B]numel";
  c2_info[30].fileLength = 0U;
  c2_info[30].fileTime1 = 0U;
  c2_info[30].fileTime2 = 0U;
  c2_info[31].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c2_info[31].name = "cast";
  c2_info[31].dominantType = "double";
  c2_info[31].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c2_info[31].fileLength = 907U;
  c2_info[31].fileTime1 = 1160446618U;
  c2_info[31].fileTime2 = 0U;
  c2_info[32].context = "";
  c2_info[32].name = "mtimes";
  c2_info[32].dominantType = "double";
  c2_info[32].resolved = "[B]mtimes";
  ...
  c2_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[36].name = "eml_guarded_nan";
  c2_info[36].dominantType = "";
  c2_info[36].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c2_info[36].fileLength = 549U;
  c2_info[36].fileTime1 = 1160446740U;
  c2_info[36].fileTime2 = 0U;
  c2_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m";
  c2_info[37].name = "eq";
  c2_info[37].dominantType = "double";
  c2_info[37].resolved = "[B]eq";
...
/* SFunction Glue Code */
void sf_c2_Puncture_Through_Wall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_Puncture_Through_Wall_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_Puncture_Through_Wall(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_Puncture_Through_Wall();
  initialize_c2_Puncture_Through_Wall();
}

static void sf_opaque_enable_c2_Puncture_Through_Wall(void *chartInstanceVar)
{
  enable_c2_Puncture_Through_Wall();
}

static void sf_opaque_disable_c2_Puncture_Through_Wall(void *chartInstanceVar)
{
  disable_c2_Puncture_Through_Wall();
}

static void sf_opaque_gateway_c2_Puncture_Through_Wall(void *chartInstanceVar)
{
  sf_c2_Puncture_Through_Wall();
}

static void sf_opaque_ext_mode_exec_c2_Puncture_Through_Wall(void
 *chartInstanceVar)
{
  ext_mode_exec_c2_Puncture_Through_Wall();
}

static void sf_opaque_terminate_c2_Puncture_Through_Wall(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c2_Puncture_Through_Wall();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Puncture_Through_Wall(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Puncture_Through_Wall",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Puncture_Through_Wall",2,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"Puncture_Through_Wall",2,6);
      sf_mark_chart_reusable_outputs(S,"Puncture_Through_Wall",2,3);
    }
    sf_set_rtw_dwork_info(S,"Puncture_Through_Wall",2);
...
static void mdlRTW_c2_Puncture_Through_Wall(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Puncture_Through_Wall", 2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_Puncture_Through_Wall(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Puncture_Through_Wall;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_Puncture_Through_Wall;
...
void c2_Puncture_Through_Wall_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Puncture_Through_Wall(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Puncture_Through_Wall(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c2_Puncture_Through_Wall_method_dispatcher.\n"
