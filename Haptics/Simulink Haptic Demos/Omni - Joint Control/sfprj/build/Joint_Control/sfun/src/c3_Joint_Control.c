...
#include "Joint_Control_sfun_debug_macros.h"
...
static SFc3_Joint_ControlInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_Joint_Control(void);
static void initialize_params_c3_Joint_Control(void);
static void enable_c3_Joint_Control(void);
static void disable_c3_Joint_Control(void);
static void ext_mode_exec_c3_Joint_Control(void);
static void finalize_c3_Joint_Control(void);
static void sf_c3_Joint_Control(void);
...
static void initialize_c3_Joint_Control(void)
{
  uint8_T *c3_is_active_c3_Joint_Control;
  c3_is_active_c3_Joint_Control = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c3_is_active_c3_Joint_Control = 0U;
}
...
static void sf_c3_Joint_Control(void)
{
  ...
  sf_debug_check_for_state_inconsistency(_Joint_ControlMachineNumber_,
...
const mxArray *sf_c3_Joint_Control_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[50])
{
  c3_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[0].name = "eml_is_integer_class";
  c3_info[0].dominantType = "char";
  c3_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m";
  c3_info[0].fileLength = 462U;
  c3_info[0].fileTime1 = 1160446744U;
  ...
  c3_info[1].fileLength = 953U;
  c3_info[1].fileTime1 = 1160446742U;
  c3_info[1].fileTime2 = 0U;
  c3_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[2].name = "class";
  c3_info[2].dominantType = "char";
  c3_info[2].resolved = "[B]class";
  ...
  c3_info[3].name = "isvector";
  c3_info[3].dominantType = "double";
  c3_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isvector.m";
  c3_info[3].fileLength = 284U;
  c3_info[3].fileTime1 = 1160446706U;
  c3_info[3].fileTime2 = 0U;
  c3_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[4].name = "false";
  c3_info[4].dominantType = "";
  c3_info[4].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c3_info[4].fileLength = 631U;
  c3_info[4].fileTime1 = 1163970766U;
  c3_info[4].fileTime2 = 0U;
  c3_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[5].name = "eml_nonsingleton_dim";
  c3_info[5].dominantType = "logical";
  c3_info[5].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c3_info[5].fileLength = 454U;
  c3_info[5].fileTime1 = 1160446750U;
  c3_info[5].fileTime2 = 0U;
  c3_info[6].context = "";
  c3_info[6].name = "mtimes";
  c3_info[6].dominantType = "double";
  c3_info[6].resolved = "[B]mtimes";
  ...
  c3_info[8].resolved = "[B]ne";
  c3_info[8].fileLength = 0U;
  c3_info[8].fileTime1 = 0U;
  c3_info[8].fileTime2 = 0U;
  c3_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[9].name = "gt";
  c3_info[9].dominantType = "double";
  c3_info[9].resolved = "[B]gt";
  c3_info[9].fileLength = 0U;
  c3_info[9].fileTime1 = 0U;
  c3_info[9].fileTime2 = 0U;
  c3_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[10].name = "int32";
  c3_info[10].dominantType = "double";
  c3_info[10].resolved = "[B]int32";
  ...
  c3_info[11].name = "eml_assert";
  c3_info[11].dominantType = "char";
  c3_info[11].resolved = "[B]eml_assert";
  ...
  c3_info[12].fileLength = 791U;
  c3_info[12].fileTime1 = 1160446618U;
  c3_info[12].fileTime2 = 0U;
  c3_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  ...
  c3_info[13].fileLength = 273U;
  c3_info[13].fileTime1 = 1160446744U;
  c3_info[13].fileTime2 = 0U;
  c3_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[14].name = "isscalar";
  c3_info[14].dominantType = "double";
  c3_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[14].fileLength = 243U;
  c3_info[14].fileTime1 = 1160446704U;
  c3_info[14].fileTime2 = 0U;
  c3_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[15].name = "isempty";
  c3_info[15].dominantType = "double";
  c3_info[15].resolved = "[B]isempty";
  c3_info[15].fileLength = 0U;
  c3_info[15].fileTime1 = 0U;
  c3_info[15].fileTime2 = 0U;
  c3_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[16].name = "isinteger";
  c3_info[16].dominantType = "double";
  c3_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c3_info[16].fileLength = 254U;
  c3_info[16].fileTime1 = 1160446620U;
  c3_info[16].fileTime2 = 0U;
  c3_info[17].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[17].name = "floor";
  c3_info[17].dominantType = "double";
  c3_info[17].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c3_info[17].fileLength = 595U;
  c3_info[17].fileTime1 = 1163970736U;
  c3_info[17].fileTime2 = 0U;
  c3_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[18].name = "isnumeric";
  c3_info[18].dominantType = "double";
  c3_info[18].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c3_info[18].fileLength = 250U;
  c3_info[18].fileTime1 = 1160446622U;
  c3_info[18].fileTime2 = 0U;
  c3_info[19].context = "";
  c3_info[19].name = "sum";
  c3_info[19].dominantType = "double";
  c3_info[19].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[19].fileLength = 2616U;
  c3_info[19].fileTime1 = 1163970698U;
  ...
  c3_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[21].name = "not";
  c3_info[21].dominantType = "logical";
  c3_info[21].resolved = "[B]not";
  c3_info[21].fileLength = 0U;
  c3_info[21].fileTime1 = 0U;
  c3_info[21].fileTime2 = 0U;
  c3_info[22].context = "";
  c3_info[22].name = "mrdivide";
  c3_info[22].dominantType = "double";
  c3_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[22].fileLength = 653U;
  c3_info[22].fileTime1 = 1160446802U;
  c3_info[22].fileTime2 = 0U;
  c3_info[23].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[23].name = "nargout";
  c3_info[23].dominantType = "";
  c3_info[23].resolved = "[B]nargout";
  c3_info[23].fileLength = 0U;
  c3_info[23].fileTime1 = 0U;
  c3_info[23].fileTime2 = 0U;
  c3_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[24].name = "strcmp";
  c3_info[24].dominantType = "char";
  c3_info[24].resolved = "[B]strcmp";
  ...
  c3_info[26].name = "true";
  c3_info[26].dominantType = "";
  c3_info[26].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[26].fileLength = 625U;
  c3_info[26].fileTime1 = 1163970786U;
  c3_info[26].fileTime2 = 0U;
  c3_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  ...
  c3_info[33].fileLength = 244U;
  c3_info[33].fileTime1 = 1160446834U;
  c3_info[33].fileTime2 = 0U;
  c3_info[34].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[34].name = "intmax";
  c3_info[34].dominantType = "char";
  c3_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c3_info[34].fileLength = 1575U;
  c3_info[34].fileTime1 = 1160446696U;
  c3_info[34].fileTime2 = 0U;
  c3_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c3_info[35].name = "isequal";
  c3_info[35].dominantType = "double";
  c3_info[35].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[35].fileLength = 2071U;
  c3_info[35].fileTime1 = 1163970770U;
  c3_info[35].fileTime2 = 0U;
  c3_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[36].name = "isfloat";
  c3_info[36].dominantType = "double";
  c3_info[36].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isfloat.m";
  c3_info[36].fileLength = 182U;
  c3_info[36].fileTime1 = 1160446620U;
  c3_info[36].fileTime2 = 0U;
  c3_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isa.m";
  c3_info[37].name = "eq";
  c3_info[37].dominantType = "double";
  c3_info[37].resolved = "[B]eq";
  c3_info[37].fileLength = 0U;
  c3_info[37].fileTime1 = 0U;
  c3_info[37].fileTime2 = 0U;
  c3_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[38].name = "eml_check_dim";
  c3_info[38].dominantType = "double";
  c3_info[38].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_check_dim.m";
  c3_info[38].fileLength = 1470U;
  c3_info[38].fileTime1 = 1177099718U;
  c3_info[38].fileTime2 = 0U;
  c3_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[39].name = "eml_isa_uint";
  c3_info[39].dominantType = "double";
  c3_info[39].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c3_info[39].fileLength = 288U;
  c3_info[39].fileTime1 = 1163970798U;
  c3_info[39].fileTime2 = 0U;
  c3_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c3_info[40].name = "lt";
  c3_info[40].dominantType = "double";
  c3_info[40].resolved = "[B]lt";
  c3_info[40].fileLength = 0U;
  c3_info[40].fileTime1 = 0U;
  c3_info[40].fileTime2 = 0U;
  c3_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[41].name = "eml_numel";
  c3_info[41].dominantType = "double";
  c3_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[41].fileLength = 278U;
  c3_info[41].fileTime1 = 1163970802U;
  c3_info[41].fileTime2 = 0U;
  c3_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c3_info[42].name = "ge";
  c3_info[42].dominantType = "double";
  c3_info[42].resolved = "[B]ge";
  c3_info[42].fileLength = 0U;
  c3_info[42].fileTime1 = 0U;
  c3_info[42].fileTime2 = 0U;
  c3_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[43].name = "nargin";
  c3_info[43].dominantType = "";
  c3_info[43].resolved = "[B]nargin";
  ...
  c3_info[44].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c3_info[44].fileLength = 1031U;
  c3_info[44].fileTime1 = 1163970702U;
  c3_info[44].fileTime2 = 0U;
  c3_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m/eml_isequal";
  c3_info[45].name = "ndims";
  c3_info[45].dominantType = "double";
  c3_info[45].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/ndims.m";
  c3_info[45].fileLength = 236U;
  c3_info[45].fileTime1 = 1163970776U;
  c3_info[45].fileTime2 = 0U;
  c3_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c3_info[46].name = "length";
  c3_info[46].dominantType = "double";
  c3_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c3_info[46].fileLength = 347U;
  c3_info[46].fileTime1 = 1163970770U;
  c3_info[46].fileTime2 = 0U;
  c3_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c3_info[47].name = "numel";
  c3_info[47].dominantType = "double";
  c3_info[47].resolved = "[B]numel";
  c3_info[47].fileLength = 0U;
  c3_info[47].fileTime1 = 0U;
  c3_info[47].fileTime2 = 0U;
  c3_info[48].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c3_info[48].name = "double";
  c3_info[48].dominantType = "double";
  c3_info[48].resolved = "[B]double";
  c3_info[48].fileLength = 0U;
  c3_info[48].fileTime1 = 0U;
  c3_info[48].fileTime2 = 0U;
  c3_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c3_info[49].name = "logical";
  c3_info[49].dominantType = "double";
  c3_info[49].resolved = "[B]logical";
...
/* SFunction Glue Code */
void sf_c3_Joint_Control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Joint_Control_get_autoinheritance_info(void)
{
 ...
 fullDebuggerInitialization)
{
  if(ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent =
          sf_debug_initialize_chart(_Joint_ControlMachineNumber_,
         3,
         1,
         1,
         2,
        ...
        if(chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_Joint_ControlMachineNumber_,chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_Joint_ControlMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_Joint_ControlMachineNumber_,
           chartInstance.chartNumber,
           0,
           0,
           0);
    ...
    sf_debug_reset_current_state_configuration(_Joint_ControlMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c3_Joint_Control(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_Joint_Control();
  initialize_c3_Joint_Control();
}

static void sf_opaque_enable_c3_Joint_Control(void *chartInstanceVar)
{
  enable_c3_Joint_Control();
}

static void sf_opaque_disable_c3_Joint_Control(void *chartInstanceVar)
{
  disable_c3_Joint_Control();
}

static void sf_opaque_gateway_c3_Joint_Control(void *chartInstanceVar)
{
  sf_c3_Joint_Control();
}

static void sf_opaque_ext_mode_exec_c3_Joint_Control(void *chartInstanceVar)
{
  ext_mode_exec_c3_Joint_Control();
}

static void sf_opaque_terminate_c3_Joint_Control(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c3_Joint_Control();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Joint_Control(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Joint_Control(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Joint_Control",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Joint_Control",3,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Joint_Control",3,1);
      sf_mark_chart_reusable_outputs(S,"Joint_Control",3,1);
    }
    sf_set_rtw_dwork_info(S,"Joint_Control",3);
...
static void mdlRTW_c3_Joint_Control(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Joint_Control", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_Joint_Control(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Joint_Control;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c3_Joint_Control;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c3_Joint_Control;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c3_Joint_Control;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c3_Joint_Control;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_Joint_Control;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_Joint_Control;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Joint_Control;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c3_Joint_Control;
...
void c3_Joint_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Joint_Control(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Joint_Control(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Joint_Control(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_Joint_Control_method_dispatcher.\n"
