...
static SFc8_Joint_ControlInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_Joint_Control(void);
static void initialize_params_c8_Joint_Control(void);
static void enable_c8_Joint_Control(void);
static void disable_c8_Joint_Control(void);
static void ext_mode_exec_c8_Joint_Control(void);
static void finalize_c8_Joint_Control(void);
static void sf_c8_Joint_Control(void);
...
static void initialize_c8_Joint_Control(void)
{
  uint8_T *c8_is_active_c8_Joint_Control;
  c8_is_active_c8_Joint_Control = (uint8_T *)ssGetDWork(chartInstance.S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_Joint_Control = 0U;
}
...
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[23])
{
  ...
  c8_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[1].fileLength = 653U;
  c8_info[1].fileTime1 = 1160446802U;
  c8_info[1].fileTime2 = 0U;
  c8_info[2].context = "";
  c8_info[2].name = "pi";
  c8_info[2].dominantType = "";
  c8_info[2].resolved = "[B]pi";
  c8_info[2].fileLength = 0U;
  c8_info[2].fileTime1 = 0U;
  c8_info[2].fileTime2 = 0U;
  c8_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[3].name = "eq";
  c8_info[3].dominantType = "double";
  c8_info[3].resolved = "[B]eq";
  c8_info[3].fileLength = 0U;
  c8_info[3].fileTime1 = 0U;
  c8_info[3].fileTime2 = 0U;
  c8_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[4].name = "eml_assert";
  c8_info[4].dominantType = "char";
  c8_info[4].resolved = "[B]eml_assert";
  c8_info[4].fileLength = 0U;
  c8_info[4].fileTime1 = 0U;
  c8_info[4].fileTime2 = 0U;
  c8_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[5].name = "isinteger";
  c8_info[5].dominantType = "double";
  c8_info[5].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isinteger.m";
  c8_info[5].fileLength = 254U;
  c8_info[5].fileTime1 = 1160446620U;
  ...
  c8_info[7].name = "rdivide";
  c8_info[7].dominantType = "double";
  c8_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[7].fileLength = 4533U;
  c8_info[7].fileTime1 = 1177099748U;
  c8_info[7].fileTime2 = 0U;
  c8_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c8_info[8].name = "length";
  c8_info[8].dominantType = "double";
  c8_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c8_info[8].fileLength = 347U;
  c8_info[8].fileTime1 = 1163970770U;
  c8_info[8].fileTime2 = 0U;
  c8_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[9].name = "isreal";
  c8_info[9].dominantType = "double";
  c8_info[9].resolved = "[B]isreal";
  c8_info[9].fileLength = 0U;
  c8_info[9].fileTime1 = 0U;
  c8_info[9].fileTime2 = 0U;
  c8_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c8_info[10].name = "nargin";
  c8_info[10].dominantType = "";
  c8_info[10].resolved = "[B]nargin";
  ...
  c8_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_numel.m";
  c8_info[12].name = "numel";
  c8_info[12].dominantType = "double";
  c8_info[12].resolved = "[B]numel";
  ...
  c8_info[13].name = "strcmp";
  c8_info[13].dominantType = "char";
  c8_info[13].resolved = "[B]strcmp";
  ...
  c8_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c8_info[15].name = "isnumeric";
  c8_info[15].dominantType = "double";
  c8_info[15].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/isnumeric.m";
  c8_info[15].fileLength = 250U;
  c8_info[15].fileTime1 = 1160446622U;
  ...
  c8_info[21].name = "isscalar";
  c8_info[21].dominantType = "double";
  c8_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isscalar.m";
  c8_info[21].fileLength = 243U;
  c8_info[21].fileTime1 = 1160446704U;
  c8_info[21].fileTime2 = 0U;
  c8_info[22].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c8_info[22].name = "ischar";
  c8_info[22].dominantType = "char";
  c8_info[22].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/strfun/ischar.m";
  c8_info[22].fileLength = 244U;
  c8_info[22].fileTime1 = 1160446834U;
...
/* SFunction Glue Code */
void sf_c8_Joint_Control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Joint_Control_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c8_Joint_Control(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_Joint_Control();
  initialize_c8_Joint_Control();
}

static void sf_opaque_enable_c8_Joint_Control(void *chartInstanceVar)
{
  enable_c8_Joint_Control();
}

static void sf_opaque_disable_c8_Joint_Control(void *chartInstanceVar)
{
  disable_c8_Joint_Control();
}

static void sf_opaque_gateway_c8_Joint_Control(void *chartInstanceVar)
{
  sf_c8_Joint_Control();
}

static void sf_opaque_ext_mode_exec_c8_Joint_Control(void *chartInstanceVar)
{
  ext_mode_exec_c8_Joint_Control();
}

static void sf_opaque_terminate_c8_Joint_Control(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c8_Joint_Control();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Joint_Control(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Joint_Control(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Joint_Control",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("Joint_Control",8,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Joint_Control",8,1);
      sf_mark_chart_reusable_outputs(S,"Joint_Control",8,1);
    }
    sf_set_rtw_dwork_info(S,"Joint_Control",8);
...
static void mdlRTW_c8_Joint_Control(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Joint_Control", 8);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c8_Joint_Control(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c8_Joint_Control;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_Joint_Control;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c8_Joint_Control;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c8_Joint_Control;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c8_Joint_Control;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_Joint_Control;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_Joint_Control;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_Joint_Control;
  chartInstance.chartInfo.extModeExec = sf_opaque_ext_mode_exec_c8_Joint_Control;
...
void c8_Joint_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Joint_Control(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Joint_Control(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Joint_Control(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c8_Joint_Control_method_dispatcher.\n"
