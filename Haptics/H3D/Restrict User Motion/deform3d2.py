...
for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( step_c * c - size.x / 2, step_r * r - size.y/2, side[0]) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )
		
for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( step_c * c - size.x / 2, step_r * r - size.y/2, side[1]) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )

for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( step_c * c - size.x / 2, side[0], step_r * r - size.y/2) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )		
		
for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( step_c * c - size.x / 2, side[1], step_r * r - size.y/2) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )	

for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( side[0], step_c * c - size.x / 2, step_r * r - size.y/2) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )			

for c in range( columns ):
  for r in range( rows ):
		coords.append( Vec3f( side[1], step_c * c - size.x / 2, step_r * r - size.y/2) )
		tex_coords.append( Vec2f( tc_step_c * c, tc_step_r * r ) )		
