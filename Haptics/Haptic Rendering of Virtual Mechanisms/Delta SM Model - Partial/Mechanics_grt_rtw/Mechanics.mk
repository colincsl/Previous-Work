...
MODEL                = Mechanics
MODULES              = Mechanics_data.c rt_logging.c rt_matrx.c rt_mechanism.c rt_mechanism_data.c rt_mechanism_map.c rt_nonfinite.c rt_printf.c 
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f C:\Users\Colin\AppData\Roaming\MATHWO~1\MATLAB\R2007b\mexopts.bat
VISUAL_VER           = 8.0
OPTIMIZATION_FLAGS   = /Od /Oy- /DNDEBUG

#--------------------------- Model and reference models -----------------------
MODELLIB                  = Mechanicslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Mechanics_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Colin\Desktop\haptics\sim\Mechanics_grt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Colin\Desktop\haptics\sim
...
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\mech\lib\win32\mech_vc.lib
!else
LIBS = $(LIBS) mech.lib
!endif 
!if "$(OPT_OPTS)" == "$(DEFAULT_OPT_OPTS)"
