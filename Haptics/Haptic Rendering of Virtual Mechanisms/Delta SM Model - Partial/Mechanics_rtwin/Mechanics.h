...
typedef struct {
  ...
  real_T Block1_o1[3];                 /* '<S8>/Block#1' */
  real_T Block1_o2[10];                /* '<S8>/Block#1' */
  real_T Block1_o3;                    /* '<S8>/Block#1' */
  real_T _gravity_conversion[3];       /* '<S8>/_gravity_conversion' */
  real_T Block2;                       /* '<S8>/Block#2' */
  real_T Block3;                       /* '<S8>/Block#3' */
} BlockIO_Mechanics;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  void *Block1_PWORK;                  /* '<S8>/Block#1' */
  void *Block2_PWORK;                  /* '<S8>/Block#2' */
  void *Block3_PWORK;                  /* '<S8>/Block#3' */
  int_T Block1_IWORK;                  /* '<S8>/Block#1' */
  int_T Block3_IWORK;                  /* '<S8>/Block#3' */
} D_Work_Mechanics;

/* Continuous states (auto storage) */
typedef struct {
  real_T Block1_CSTATE[10];            /* '<S8>/Block#1' */
...
/* State disabled  */
typedef struct {
  boolean_T Block1_CSTATE[10];         /* '<S8>/Block#1' */
...
} ExternalInputs_Mechanics;

/* External outputs (root outports fed by signals with auto storage) */
typedef struct {
  real_T Out1[3];                      /* '<Root>/Out1' */
} ExternalOutputs_Mechanics;

/* Backward compatible GRT Identifiers */
#define rtB                            Mechanics_B
#define BlockIO                        BlockIO_Mechanics
#define rtU                            Mechanics_U
#define ExternalInputs                 ExternalInputs_Mechanics
#define rtX                            Mechanics_X
#define ContinuousStates               ContinuousStates_Mechanics
#define rtY                            Mechanics_Y
#define ExternalOutputs                ExternalOutputs_Mechanics
...
struct Parameters_Mechanics {
  real_T Constant4_Value;              /* Expression: 500
                                        * '<Root>/Constant4'
                                        */
  ...
  real_T Constant3_Value;              /* Expression: 0
                                        * 'synthesized block'
                                        */
  real_T Block1_SimMechanicsRuntimeParam[222];/* Computed Parameter: SimMechanicsRuntimeParameters
                                               * '<S8>/Block#1'
                                               */
...
/* External inputs (root inport signals with auto storage) */
extern ExternalInputs_Mechanics Mechanics_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExternalOutputs_Mechanics Mechanics_Y;
 ...
 *
 * '<Root>' : Mechanics
 * '<S1>'   : Mechanics/Body Actuator
 * '<S2>'   : Mechanics/Body Sensor
 * '<S3>'   : Mechanics/Ground
 * '<S4>'   : Mechanics/Ground1
 * '<S5>'   : Mechanics/Joint Actuator1
 * '<S6>'   : Mechanics/Joint Actuator2
 * '<S7>'   : Mechanics/Machine Environment
 * '<S8>'   : Mechanics/Ground/_mech_engine
 * '<S9>'   : Mechanics/Ground/_mech_engine/actuators
 * '<S10>'  : Mechanics/Ground/_mech_engine/sensors
 * '<S11>'  : Mechanics/Ground/_mech_engine/actuators/stub actuators
 * '<S12>'  : Mechanics/Ground/_mech_engine/sensors/stub sensors
 */
