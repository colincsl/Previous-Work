...
#
# File    : raccel_vc.tmf   $Revision: 1.1.6.3 $
#
# Abstract:
...
MODEL           = Crane
MODULES         = Crane_data.c rt_logging.c rt_mechanism.c rt_mechanism_data.c rt_mechanism_map.c rt_nonfinite.c 
MAKEFILE        = Crane.mk
...
NCSTATES            = 14
MULTITASKING        = 0
PCMATLABROOT        = C:\\Program Files\\MATLAB\\R2007b
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\colinlea\COLINL~1\BARSYS~1\CRANE_~3
...
CFLAGS   = $(CC_OPTS) $(CPP_REQ_DEFINES) $(USER_INCLUDES) \
	   $(cflags) $(cvarsmt) $(PARAM_CC_OPTS) $(CFLAGS_VERSPECIFIC)
CPPFLAGS = $(CPP_OPTS) $(CC_OPTS) $(CPP_REQ_DEFINES) $(USER_INCLUDES) \
	   $(cflags) $(cvarsmt) $(PARAM_CC_OPTS) $(CPPFLAGS_VERSPECIFIC)
...
MAT_LIBS = $(MATLAB_ROOT)\extern\lib\win32\microsoft\libut.lib \
	   ...
	   $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmwmathutil.lib \
           $(MATLAB_ROOT)\rtw\c\lib\win32\rsim_engine.lib
