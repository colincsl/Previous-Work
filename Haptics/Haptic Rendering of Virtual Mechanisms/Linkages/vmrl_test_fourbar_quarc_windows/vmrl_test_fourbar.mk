...
MODEL                = vmrl_test_fourbar
MODULES              = rt_mechanism.c rt_mechanism_data.c rt_mechanism_map.c rt_nonfinite.c vmrl_test_fourbar_data.c vmrl_test_fourbar_main.c 
MAKEFILE             = vmrl_test_fourbar.mk
...
MODELLIB                  = vmrl_test_fourbarlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = vmrl_test_fourbar_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\colinlea\Finish\COLIN'~1\Linkages\VMRL_T~1
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\colinlea\Finish\COLIN'~1\Linkages
