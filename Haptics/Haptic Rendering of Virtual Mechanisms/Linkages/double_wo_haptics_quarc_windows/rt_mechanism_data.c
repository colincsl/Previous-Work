 ...
 */
void rt_vector_to_machine_parameters_double_wo_haptics_9648c7ca(const real_T *_mech_rtP, MachineParameters_double_wo_haptics_9648c7ca *_mech_rtS)
{
    /*
 ...
 */
void rt_machine_parameters_to_vector_double_wo_haptics_9648c7ca(const MachineParameters_double_wo_haptics_9648c7ca *_mech_rtS, real_T *_mech_rtP)
{
    /*
