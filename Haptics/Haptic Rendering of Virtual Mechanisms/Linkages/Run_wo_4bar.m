function [] = Run_wo_4bar(hObject)
%RUN_WO_4BAR Summary of this function goes here
%   Detailed explanation goes here
obj = guidata(hObject);

load_system('Fourbar_wo_haptics');
%qc_load_model('Fourbar_wo_haptics');
disp('System Loaded')

try
    qc_start_model('Fourbar_wo_haptics');
catch
end
...
set(obj.sys_out, 'String', 'Running 4bar without feeback...')

try
    while(qc_is_model_loaded('Fourbar_wo_haptics'))
        pause(1);
    end
catch
    pause(1);
