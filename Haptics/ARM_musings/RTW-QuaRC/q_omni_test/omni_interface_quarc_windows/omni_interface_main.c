...
typedef omni_interface_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * omni_interface(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(omni_interface_M, GBLbuf.message);
}
  ...
  control_c_handler(int signal_number)
{
  ...
  {
    stream_shutdown(omni_interface_DWork.StreamAnswer_Client);
    stream_shutdown(omni_interface_DWork.StreamAnswer_Listener);
    stream_shutdown(omni_interface_DWork.StreamAnswer1_Client);
    stream_shutdown(omni_interface_DWork.StreamAnswer1_Listener);
  }
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://omni_interface:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: omni_interface -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
