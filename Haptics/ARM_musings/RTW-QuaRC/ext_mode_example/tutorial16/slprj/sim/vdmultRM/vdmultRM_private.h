...
# define rtmIsSampleHit(rtm, sti, tid) ( (ssGetSampleHitPtr((rtm)->_mdlRefSfcnS))[vdmultRM_GlobalTID[sti]] == 1 )
#endif

#ifndef rtmGetTPtr
# define rtmGetTPtr(rtm)               _ssGetTPtr((rtm)->_mdlRefSfcnS)
#endif
...
# define rtmGetClockTick0(rtm)         ( *((ssGetTimingBridge((rtm)->_mdlRefSfcnS)->clockTick[vdmultRM_GlobalTID[0]])) )
#endif

#ifndef rtmGetClockTickH0
# define rtmGetClockTickH0(rtm)        ( *(ssGetTimingBridge((rtm)->_mdlRefSfcnS)->clockTickH[vdmultRM_GlobalTID[0]]) )
#endif
...
# define rtmGetTaskTime(rtm, sti)      (ssGetTPtr((rtm)->_mdlRefSfcnS))[vdmultRM_GlobalTID[sti]]
#endif
