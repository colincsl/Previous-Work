...
#define simulink_test_rtModel          RT_MODEL_simulink_test
...
} D_Work_simulink_test;

/* Backward compatible GRT Identifiers */
#define rtXdot                         simulink_test_Xdot
#define StateDerivatives               StateDerivatives_simulink_test
#define tXdis                          simulink_test_Xdis
#define StateDisabled                  StateDisabled_simulink_test
#define rtP                            simulink_test_P
#define Parameters                     Parameters_simulink_test
#define rtDWork                        simulink_test_DWork
#define D_Work                         D_Work_simulink_test

/* Parameters (auto storage) */
struct Parameters_simulink_test {
...
extern Parameters_simulink_test simulink_test_P;

/* Block states (auto storage) */
extern D_Work_simulink_test simulink_test_DWork;
...
extern "C" {
  ...
  extern RT_MODEL_simulink_test *simulink_test_M;
