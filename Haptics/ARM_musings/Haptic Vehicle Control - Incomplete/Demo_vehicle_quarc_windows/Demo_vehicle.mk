...
MODEL                = Demo_vehicle
MODULES              = Demo_vehicle_data.c Demo_vehicle_main.c rt_nonfinite.c 
MAKEFILE             = Demo_vehicle.mk
...
MODELLIB                  = Demo_vehiclelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Demo_vehicle_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\colinlea\Demo\Demo_vehicle_quarc_windows
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\colinlea\Demo
