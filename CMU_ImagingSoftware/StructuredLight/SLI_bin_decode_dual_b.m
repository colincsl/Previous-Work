...
% ProCam_params_save 
% [dim_c, KK_c, kc_c, dim_p, KK_p, kc_p, om, trans_p] = parse_yaml_calib('SL_Oct_14_546pm_12x8.yaml');
[dim_c, KK_c, kc_c, dim_p, KK_p, kc_p, om, trans_p] = parse_yaml_calib('sept_08_610pm.yaml');

kc_p(5) = 0;
kc_c(5) = 0;
trans_p = trans_p' * 30/200;
...
[XL, XR] = stereo_triangulation([x_proj'; y_proj'], [x_cam'; y_cam'], om, -trans_p, fc_p, cc_p, kc_p*1, alpha_c_p,      fc_c, cc_c, kc_c, alpha_c_c);        
