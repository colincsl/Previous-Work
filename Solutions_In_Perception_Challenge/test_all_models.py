...
for file_i in data_files:
	if file_i.rfind('.bag')>=0 and file_i.rfind('.csv') < 0:
		...
		os.system('rosrun mrol_sip detector.py -B %s -C config.yaml --camera_info camera_info --image image_color --points points --team_name TeamFranklin --run_number 0 --viz_on 1' % fname)
